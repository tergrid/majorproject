...
}`)}function u(o){return o.mode===x.SKETCH||o.mode===x.MIXED}function p(o){return o.mode===x.SOLID||o.mode===x.MIXED}var x,F;!function(o){o[o.SOLID=0]="SOLID",o[o.SKETCH=1]="SKETCH",o[o.MIXED=2]="MIXED",o[o.COUNT=3]="COUNT"}(x||(x={})),function(o){o[o.REGULAR=0]="REGULAR",o[o.SILHOUETTE=1]="SILHOUETTE"}(F||(F={}));export{F as EdgeSilhouette,v as EdgeUtil,x as EdgeUtilMode,u as usesSketchLogic,p as usesSolidLogic};
