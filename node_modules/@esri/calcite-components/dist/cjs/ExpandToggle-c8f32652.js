...
const resources$1 = require('./resources-3c8d9086.js');
const resources = require('./resources-7dff0197.js');
...
const ExpandToggle = ({ expanded, expandText, collapseText, toggle, el, position, tooltip, ref, scale, }) => {
    ...
    const actionNode = (index.h("calcite-action", { icon: expanded ? expandIcon : collapseIcon, onClick: toggle, ref: (referenceElement) => setTooltipReference({ tooltip, referenceElement, expanded, ref }), scale: scale, text: text, textEnabled: expanded, title: !expanded && !tooltip ? text : null }));
    return actionNode;
};
...
//# sourceMappingURL=ExpandToggle-c8f32652.js.map