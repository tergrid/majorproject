...
const AccordionItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '522a393c2e17a05258c6e80280d89085936ea3d9' }, index.h("div", { key: '513dd854784b90e76aaacb698d416173c7d99896', class: {
                [`icon-position--${this.iconPosition}`]: true,
                [`icon-type--${this.iconType}`]: true,
            } }, index.h("div", { key: '338293722fe860e42975aaf8492fe1636e6b2b1d', class: { [CSS.header]: true, [resources.CSS_UTILITY.rtl]: dir === "rtl" } }, this.renderActionsStart(), index.h("div", { key: '06e7b4afc2bb10d31c236a7b879f9d4bb4150c61', "aria-controls": IDS.section, "aria-expanded": dom.toAriaBoolean(this.expanded), class: CSS.headerContent, id: IDS.sectionToggle, onClick: this.itemHeaderClickHandler, ref: this.storeHeaderEl, role: "button", tabindex: "0" }, index.h("div", { key: 'ddf1b20cafec62653948b706a42c4cfdd8b61dce', class: CSS.headerContainer }, iconStartEl, index.h("div", { key: '3143804a918838326fa0e192e78c8f4ec0c0837c', class: CSS.headerText }, index.h("span", { key: '9588f26ff8e3258a1c3df70dac96951bc786407a', class: CSS.heading }, this.heading), description ? index.h("span", { class: CSS.description }, description) : null), iconEndEl), index.h("calcite-icon", { key: '49f2577d70dbb483cf3e401638ce5919590d47d1', class: CSS.expandIcon, icon: this.iconType === "chevron"
                ? "chevronDown"
                : this.iconType === "caret"
                    ? "caretDown"
                    : this.expanded
                        ? "minus"
                        : "plus", scale: component.getIconScale(this.scale) })), this.renderActionsEnd()), index.h("section", { key: '37df95c86d7c8ffc0542a1b50d8a0cfff472b8f5', "aria-labelledby": IDS.sectionToggle, class: CSS.content, id: IDS.section }, index.h("slot", { key: '8770002acd319a3b6ac9f9df4f29c9972d605f0f' })))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
    ...
    async setFocus() {
        await component.componentFocusable(this.el);
        this.headerEl.focus();
    }
