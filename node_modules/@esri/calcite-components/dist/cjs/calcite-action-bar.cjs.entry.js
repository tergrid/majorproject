...
const ExpandToggle = require('./ExpandToggle-c8f32652.js');
...
require('./resources-3c8d9086.js');
require('./resources-7dff0197.js');
...
const ActionBar = class {
    ...
    renderBottomActionGroup() {
        ...
        const expandToggleNode = !expandDisabled ? (index.h(ExpandToggle.ExpandToggle, { collapseText: messages.collapse, el: el, expandText: messages.expand, expanded: expanded, position: position, ref: this.setExpandToggleRef, scale: scale, toggle: toggleExpand, tooltip: this.expandTooltip })) : null;
    ...
    render() {
        return (index.h(index.Host, { key: 'dceae74686052a5456cd292a29172e76eab7cfb2', onCalciteActionMenuOpen: this.actionMenuOpenHandler }, index.h("slot", { key: '4fba033b9742564034eb58e3cbcf63b9cd68e6ea', onSlotchange: this.handleDefaultSlotChange }), this.renderBottomActionGroup()));
    }
