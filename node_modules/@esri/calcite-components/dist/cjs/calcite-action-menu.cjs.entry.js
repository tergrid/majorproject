...
const ActionMenu = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '2e60f0bcf41f683c77fe93d6f776fb1e9ff9f9a7' }, this.renderMenuButton(), this.renderMenuItems(), index.h("slot", { key: 'e9d8dac34c46653b17c012ab01ed2c7bea3938ba', name: resources.SLOTS.tooltip, onSlotchange: this.updateTooltip })));
    }
