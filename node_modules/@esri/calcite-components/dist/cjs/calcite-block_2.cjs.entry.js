...
const conditionalSlot = require('./conditionalSlot-4479a00b.js');
...
const Heading = require('./Heading-e1c5c89e.js');
...
const Block = class {
    ...
    render() {
        ...
        const headerContent = (index.h("header", { key: '89ca745bb149243a8a16bd9a1fb06bb6caf0dcde', class: CSS$1.header, id: IDS$1.header }, this.renderIcon(), this.renderTitle()));
        ...
        const headerNode = (index.h("div", { key: '3c7722b8d21cfe2a96611a27436327f0e01a1c13', class: CSS$1.headerContainer }, this.dragHandle ? index.h("calcite-handle", { label: heading }) : null, collapsible ? (index.h("button", { "aria-controls": IDS$1.content, "aria-describedby": IDS$1.header, "aria-expanded": collapsible ? dom.toAriaBoolean(open) : null, class: CSS$1.toggle, id: IDS$1.toggle, onClick: this.onHeaderClick, title: toggleLabel }, headerContent, index.h("calcite-icon", { "aria-hidden": "true", class: CSS$1.toggleIcon, icon: collapseIcon, scale: "s" }))) : (headerContent), hasControl ? (index.h("div", { class: CSS$1.controlContainer }, index.h("slot", { name: SLOTS.control }))) : null, hasMenuActions ? (index.h("calcite-action-menu", { label: messages.options, overlayPositioning: this.overlayPositioning }, index.h("slot", { name: SLOTS.headerMenuActions }))) : null));
        return (index.h(index.Host, { key: '2b4bc16c96ad283fc0cb7fdc962d45f9047d2025' }, index.h(interactive.InteractiveContainer, { key: '3d846b4884a822a8e4d1550324c1e60d02567622', disabled: this.disabled }, index.h("article", { key: 'aba63d45e2c228f297abb31963c63f1e4bc980c9', "aria-busy": dom.toAriaBoolean(loading), class: {
                [CSS$1.container]: true,
            } }, headerNode, index.h("section", { key: 'a83029c21f41ea740a1a5e11e42a0613d5fd77cc', "aria-labelledby": IDS$1.toggle, class: CSS$1.content, hidden: !open, id: IDS$1.content, ref: this.setTransitionEl }, this.renderScrim())))));
    }
...
const BlockSection = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '768a133e8082de210c0a740a5ab02117c96441a1' }, headerNode, index.h("section", { key: '43a1e364a397b7b62f90a8bae2eea361816cba76', "aria-labelledby": IDS.toggle, class: CSS.content, hidden: !open, id: IDS.content }, index.h("slot", { key: 'af10f99c85d67beb6d0f06d66dddef1b98aa774d' }))));
    }
    static get assetsDirs() { return ["assets"]; }
    get el() { return index.getElement(this); }
    static get watchers() { return {
