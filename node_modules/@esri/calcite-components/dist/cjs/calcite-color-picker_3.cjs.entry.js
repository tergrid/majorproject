...
const utils = require('./utils-4399b985.js');
const throttle = require('./throttle-a93fd8f9.js');
...
const ColorPicker = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: '5f347cb136350e7661b7b479ee86a16bb85414c3', disabled: this.disabled }, index.h("div", { key: '0294cbc1d16db228c22a2ae1bd061d9a683c1378', class: CSS$2.container }, index.h("div", { key: 'f7531da7e77293d52f5f8220443258e40f07f2d3', class: CSS$2.controlAndScope }, index.h("canvas", { key: '21bd0117fa182a4b40b092a905dee76714b94c78', class: CSS$2.colorField, onPointerDown: this.handleColorFieldPointerDown, ref: this.initColorField }), index.h("div", { key: 'b5c64766b5e4bc4e7971dfe64f07c43c8c9666f8', "aria-label": vertical ? messages.value : messages.saturation, "aria-valuemax": vertical ? HSV_LIMITS.v : HSV_LIMITS.s, "aria-valuemin": "0", "aria-valuenow": (vertical ? color?.saturationv() : color?.value()) || "0", class: { [CSS$2.scope]: true, [CSS$2.colorFieldScope]: true }, onKeyDown: this.handleColorFieldScopeKeyDown, ref: this.storeColorFieldScope, role: "slider", style: {
                top: `${adjustedColorFieldScopeTop || 0}px`,
                left: `${adjustedColorFieldScopeLeft || 0}px`,
            }, tabindex: "0" })), index.h("div", { key: '2a821875af0e6b0ac8aefc3415c6f2f23bae2cae', class: CSS$2.previewAndSliders }, index.h("calcite-color-picker-swatch", { key: 'ec3f7dd7b0ffc702f2aba80a7b7e270c6dc95dbd', class: CSS$2.preview, color: selectedColorInHex, scale: "l" }), index.h("div", { key: '82323c8fb8781d1be62f5c9e15ab491593751af8', class: CSS$2.sliders }, index.h("div", { key: '11702f0c4d40377e89d1c3ec6b5b0ba0f166b034', class: CSS$2.controlAndScope }, index.h("canvas", { key: 'c175af1d7e64f535cc2748d86fc882bf8436729d', class: { [CSS$2.slider]: true, [CSS$2.hueSlider]: true }, onPointerDown: this.handleHueSliderPointerDown, ref: this.initHueSlider }), index.h("div", { key: 'c16a4a0eaa7dd4cbcf7ac3faf589afd11b9a77e7', "aria-label": messages.hue, "aria-valuemax": HSV_LIMITS.h, "aria-valuemin": "0", "aria-valuenow": color?.round().hue() || DEFAULT_COLOR$1.round().hue(), class: { [CSS$2.scope]: true, [CSS$2.hueScope]: true }, onKeyDown: this.handleHueScopeKeyDown, ref: this.storeHueScope, role: "slider", style: {
                top: `${adjustedHueScopeTop}px`,
                left: `${adjustedHueScopeLeft}px`,
            }, tabindex: "0" })), alphaChannel ? (index.h("div", { class: CSS$2.controlAndScope }, index.h("canvas", { class: { [CSS$2.slider]: true, [CSS$2.opacitySlider]: true }, onPointerDown: this.handleOpacitySliderPointerDown, ref: this.initOpacitySlider }), index.h("div", { "aria-label": messages.opacity, "aria-valuemax": OPACITY_LIMITS.max, "aria-valuemin": OPACITY_LIMITS.min, "aria-valuenow": (color || DEFAULT_COLOR$1).round().alpha(), class: { [CSS$2.scope]: true, [CSS$2.opacityScope]: true }, onKeyDown: this.handleOpacityScopeKeyDown, ref: this.storeOpacityScope, role: "slider", style: {
...
const ColorPickerHexInput = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'ce81e626a720cd37d45facd4ca1f9dd748df094c', class: CSS$1.container }, index.h("calcite-input-text", { key: 'bc44d75c4752f78dc0a1b108e3f3a2a304172559', class: CSS$1.hexInput, label: messages?.hex || hexLabel, maxLength: 6, onCalciteInputTextChange: this.onHexInputChange, onCalciteInternalInputTextBlur: this.onHexInputBlur, onKeyDown: this.onInputKeyDown, onPaste: this.onHexInputPaste, prefixText: "#", ref: this.storeHexInputRef, scale: inputScale, value: hexInputValue }), alphaChannel ? (index.h("calcite-input-number", { class: CSS$1.opacityInput, key: "opacity-input", label: messages?.opacity, max: OPACITY_LIMITS.max, maxLength: 3, min: OPACITY_LIMITS.min, numberButtonType: "none", numberingSystem: this.numberingSystem, onCalciteInputNumberChange: this.onOpacityInputChange, onCalciteInternalInputNumberBlur: this.onOpacityInputBlur, onKeyDown: this.onInputKeyDown, ref: this.storeOpacityInputRef, scale: inputScale, suffixText: "%", value: opacityInputValue })) : null));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
