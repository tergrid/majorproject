...
const Slider = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '86ec64bfb42495e7fc927751ad7d2a667b0a625d', id: id, onKeyDown: this.handleKeyDown, onTouchStart: this.handleTouchStart }, index.h(interactive.InteractiveContainer, { key: '842aacebaf4199a088f71b2d2ad7420845cf2629', disabled: this.disabled }, index.h("div", { key: '364511c370bbf454958accdd4c3084a1c339de22', "aria-label": label.getLabelText(this), class: {
            ...
            } }, this.renderGraph(), index.h("div", { key: 'c8366d13976102bdabf6bca85523f295e9713c53', class: CSS.track, ref: this.storeTrackRef }, index.h("div", { key: '9b078da10285e125f525a8307b52457cd83edf89', class: CSS.trackRange, onPointerDown: this.onTrackPointerDown, style: trackRangePlacementStyles }), index.h("div", { key: '78fe14d82f98b323d21db80061d64cd348495793', class: CSS.ticks }, this.tickValues.map((tick) => {
        ...
        }))), index.h("div", { key: '65cd9bb7414a77ba26468a9253369ed0bca0503f', class: CSS.thumbContainer }, minThumb, thumb, index.h(form.HiddenFormInputSlot, { key: '83a8c80504e00feb2f5fd584efcdeda53a65c2fd', component: this }))))));
    }
