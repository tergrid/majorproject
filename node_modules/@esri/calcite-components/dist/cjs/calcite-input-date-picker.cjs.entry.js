...
const utils = require('./utils-e6b922f9.js');
const dom = require('./dom-8530141d.js');
const floatingUi = require('./floating-ui-7dc0dc5c.js');
...
const InputDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c913bed40a4d29276ed4d3738e35fa2d6d17ed69', onBlur: this.blurHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { key: '4b880414f337bdbc52a83cc8925220b18610bed1', disabled: this.disabled }, this.localeData && (index.h("div", { key: 'b5f4fdc2696865f91b31a2bccaf01812680b0453', class: CSS.inputContainer }, index.h("div", { key: 'f3cd5abd032fffc4b0d035d0ccd8c91b8974d95e', class: CSS.inputWrapper, "data-position": "start", onClick: this.onInputWrapperClick, onPointerDown: this.onInputWrapperPointerDown, ref: this.setStartWrapper }, index.h("calcite-input-text", { key: '324d01404a24d65963bcc66857748525fc904f74', "aria-autocomplete": "none", "aria-controls": this.dialogId, "aria-describedby": this.placeholderTextId, "aria-expanded": dom.toAriaBoolean(this.open), "aria-haspopup": "dialog", class: {
                [CSS.input]: true,
            ...
            this.renderToggleIcon(this.open && this.focusedInput === "start"), index.h("span", { key: 'a3becf79e7bcaf182ce4431907c9b3a8055a4b08', "aria-hidden": "true", class: CSS.assistiveText, id: this.placeholderTextId }, "Date Format: ", this.localeData?.placeholder)), index.h("div", { key: 'eea3c669ea1a7d7748fb44f0d1ad910f5de20bc7', "aria-hidden": dom.toAriaBoolean(!this.open), "aria-label": messages.chooseDate, "aria-live": "polite", "aria-modal": "true", class: {
                [CSS.menu]: true,
                [CSS.menuActive]: this.open,
            }, id: this.dialogId, ref: this.setFloatingEl, role: "dialog" }, index.h("div", { key: '5ad6e26d8686cfd52e69be91c3ad62a99bd0ec32', class: {
            ...
            }, ref: this.setTransitionEl }, index.h("calcite-date-picker", { key: '2f0b5702790624ded01131be71c175a221a41b29', activeDate: this.datePickerActiveDate, activeRange: this.focusedInput, headingLevel: this.headingLevel, max: this.max, maxAsDate: this.maxAsDate, messageOverrides: this.messageOverrides, min: this.min, minAsDate: this.minAsDate, numberingSystem: numberingSystem, onCalciteDatePickerChange: this.handleDateChange, onCalciteDatePickerRangeChange: this.handleDateRangeChange, proximitySelectionDisabled: this.proximitySelectionDisabled, range: this.range, ref: this.setDatePickerRef, scale: this.scale, tabIndex: this.open ? undefined : -1, valueAsDate: this.valueAsDate }))), this.range && this.layout === "horizontal" && (index.h("div", { key: '94d12d21ee06aa375f1682f8c1eb8972c20faadd', class: CSS.horizontalArrowContainer }, index.h("calcite-icon", { key: '8b20bb4e9b7277a3bc4a94973404a0d5631c4a04', flipRtl: true, icon: "arrow-right", scale: component.getIconScale(this.scale) }))), this.range && this.layout === "vertical" && this.scale !== "s" && (index.h("div", { key: '302bc80a62abc3ba789eba52583d0237612bd20f', class: CSS.verticalArrowContainer }, index.h("calcite-icon", { key: '80df641d9652a94d33ff0fdbbdc7db155e9d51a1', icon: "arrow-down", scale: component.getIconScale(this.scale) }))), this.range && (index.h("div", { key: '85892c1a93693480323d51669d39fccce551ffca', class: CSS.inputWrapper, "data-position": "end", onClick: this.onInputWrapperClick, onPointerDown: this.onInputWrapperPointerDown, ref: this.setEndWrapper }, index.h("calcite-input-text", { key: 'bb1035f629d77ef98f50798d000d4e1e724276d3', "aria-autocomplete": "none", "aria-controls": this.dialogId, "aria-expanded": dom.toAriaBoolean(this.open), "aria-haspopup": "dialog", class: {
                [CSS.input]: true,
