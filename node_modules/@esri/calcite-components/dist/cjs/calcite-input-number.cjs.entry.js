...
const InputNumber = class {
    ...
    render() {
        ...
        const loader = (index.h("div", { key: 'a4f52e726014f5c4344ee746270965c12ed61584', class: CSS.loader }, index.h("calcite-progress", { key: 'a7dc653c7b9984ab8a38458fb87e77326e22ca4e', label: this.messages.loading, type: "indeterminate" })));
        const inputClearButton = (index.h("button", { key: '1d960bc9c14b08eba558b7ce1227eb851d08513c', "aria-label": this.messages.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputValue, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: '8d1ee036fcbff44b41856dc4f5c09f971a89432a', icon: "x", scale: component.getIconScale(this.scale) })));
        const iconEl = (index.h("calcite-icon", { key: 'c5162bc6c62e84a8c80d342dba492a675002d0e9', class: CSS.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: component.getIconScale(this.scale) }));
        const isHorizontalNumberButton = this.numberButtonType === "horizontal";
        const numberButtonsHorizontalUp = (index.h("button", { key: '53daeb9943dac80f3ecf81919b2775e3f4335cbc', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "up", disabled: this.disabled || this.readOnly, onPointerDown: this.nudgeButtonPointerDownHandler, onPointerOut: this.nudgeButtonPointerOutHandler, onPointerUp: this.nudgeButtonPointerUpHandler, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: '68e674e74c7e21cd1ced726980b2a4e2ee39abf4', icon: "chevron-up", scale: component.getIconScale(this.scale) })));
        const numberButtonsHorizontalDown = (index.h("button", { key: '648c84c9f7fad45296f0f7aa1a4fe37eb978f333', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "down", disabled: this.disabled || this.readOnly, onPointerDown: this.nudgeButtonPointerDownHandler, onPointerOut: this.nudgeButtonPointerOutHandler, onPointerUp: this.nudgeButtonPointerUpHandler, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: 'a8ae7a105913dc1c13731c4321d75459afe1c265', icon: "chevron-down", scale: component.getIconScale(this.scale) })));
        const numberButtonsVertical = (index.h("div", { key: '628ff7ec90ff45e7d091cafec90bff2ea40bf147', class: CSS.numberButtonWrapper }, numberButtonsHorizontalUp, numberButtonsHorizontalDown));
        const prefixText = index.h("div", { key: '6ccbacd041cff176f8659ebea5de90970801a6ed', class: CSS.prefix }, this.prefixText);
        const suffixText = index.h("div", { key: '79cbd5e74fe678e7cde09efa88c9e666e7d01b11', class: CSS.suffix }, this.suffixText);
        ...
        return (index.h(index.Host, { key: '2aa254fa8e0a2230dbad3d47e0763c3a5429be40', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { key: 'e1cdd1054bd5a2aa789f0d964d4e51ab47fe1d61', disabled: this.disabled }, index.h("div", { key: '043b48c477a3413d38e3d719fc29c2c9e400a7d0', class: { [CSS.inputWrapper]: true, [resources.CSS_UTILITY.rtl]: dir === "rtl" } }, this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalDown
            : null, this.prefixText ? prefixText : null, index.h("div", { key: 'b7da66e36e0c5591bc664783fc4d34b2a16080b7', class: CSS.wrapper }, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), index.h("div", { key: 'e61890fc81cfade12114bce838c83ada41fcec2c', class: CSS.actionWrapper }, index.h("slot", { key: 'c111d4c31c1cb20c65dafd30992db4c9fd17e1f0', name: SLOTS.action })), this.numberButtonType === "vertical" && !this.readOnly ? numberButtonsVertical : null, this.suffixText ? suffixText : null, this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalUp
            : null, index.h(form.HiddenFormInputSlot, { key: 'a4f6a0bc8e06139000894515be31fc5faac851eb', component: this })), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
