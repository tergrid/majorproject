...
const InputText = class {
    ...
    render() {
        ...
        const loader = (index.h("div", { key: 'f183561f485b9f7699a5f1c6a0f838fe88888fd9', class: CSS.loader }, index.h("calcite-progress", { key: 'bf24c550883391b96f43dcaafee922932e96b9b2', label: this.messages.loading, type: "indeterminate" })));
        const inputClearButton = (index.h("button", { key: '2ee2fc69aec60c3a3c6c22f871532596651304eb', "aria-label": this.messages.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputTextValue, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: 'be3e7bd1a15f316b1d0825524fc87afd7d713bde', icon: "x", scale: component.getIconScale(this.scale) })));
        const iconEl = (index.h("calcite-icon", { key: 'f5f825fea233e711960556cd41a9a936c3812397', class: CSS.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: component.getIconScale(this.scale) }));
        const prefixText = index.h("div", { key: '7aadf9ff20fd16164b18ec01e4b54287b163297b', class: CSS.prefix }, this.prefixText);
        const suffixText = index.h("div", { key: '3ba4daf9a19bc9be6bf35f691c6b9ce0c3cd52ef', class: CSS.suffix }, this.suffixText);
        const childEl = (index.h("input", { key: 'bae1fee07c8bf533b0c6ed482216c4f8b32e29f7', "aria-label": label.getLabelText(this), autocomplete: this.autocomplete, autofocus: this.el.autofocus ? true : null, class: {
        ...
        return (index.h(index.Host, { key: '0e7df5b0e69f095c0cdeb1478839edbc0f5b6946', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { key: 'b3b7d4e0cdce9dc8c58676174aa6928c94464d6f', disabled: this.disabled }, index.h("div", { key: '35f6cd1c8d01275e86fd67e8ff2433e9c88a4591', class: { [CSS.inputWrapper]: true, [resources.CSS_UTILITY.rtl]: dir === "rtl" } }, this.prefixText ? prefixText : null, index.h("div", { key: '62adeb8d3495411a5d02f13fd635fead6df482ee', class: CSS.wrapper }, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), index.h("div", { key: '9c7c5c1742ea612ff397279fde0fa18adecfa88a', class: CSS.actionWrapper }, index.h("slot", { key: '8173e626cec36e40c7b4feb2f0d0682dfe10cc2d', name: SLOTS.action })), this.suffixText ? suffixText : null, index.h(form.HiddenFormInputSlot, { key: '8e548c2ddf85b2b018b987b20fe9586461901707', component: this })), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
