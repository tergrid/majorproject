...
const CalciteMenu = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (index.h(index.Host, { key: '369a18142b5b22f203aa20f45638a7818b66d69a' }, index.h("ul", { key: '5de9fb48f9eeb427b1ef220f34326749947b25b5', "aria-label": this.label, role: this.getEffectiveRole() }, index.h("slot", { key: '96f2b70399a79589a53564bdeb01a50fa753ad7d', onSlotchange: this.handleMenuSlotChange }))));
    }
...
const CalciteMenuItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '276f8b05401a877de2602866602d47d4adfeeda6', onBlur: this.blurHandler, onFocus: this.focusHandler }, index.h("li", { key: 'd1615b223153ba107c1bf63f1084f5590113f3d1', class: {
                [CSS.container]: true,
                [CSS.isParentVertical]: this.topLevelMenuLayout === "vertical",
            }, role: "none" }, index.h("div", { key: 'e4a1fea5711442e0923898612be8f9c48c36c0e4', class: CSS.itemContent }, index.h("a", { key: '131f14ecfd17558d6a4b1722aa307fb68e0643a3', "aria-current": this.isFocused ? "page" : false, "aria-expanded": this.open, "aria-haspopup": this.hasSubmenu, "aria-label": this.label, class: { [CSS.layoutVertical]: this.layout === "vertical", [CSS.content]: true }, href: this.href, onClick: this.clickHandler, onKeyDown: this.keyDownHandler, ref: (el) => (this.anchorEl = el), rel: this.rel, role: "menuitem", tabIndex: this.isTopLevelItem ? 0 : -1, target: this.target }, this.renderItemContent(dir)), this.href && this.hasSubmenu ? this.renderDropdownAction(dir) : null), this.renderSubmenuItems(dir))));
    }
    static get assetsDirs() { return ["assets"]; }
    get el() { return index.getElement(this); }
    static get watchers() { return {
