...
const Modal = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd1e018c6bd88b964c4708d93d9a8206bd708873a', "aria-describedby": this.contentId, "aria-labelledby": this.titleId, "aria-modal": "true", role: "dialog" }, index.h("div", { key: '9e49f29d18a2e73d8e27219fae8ce80a8aaa70a8', class: {
                [CSS.container]: true,
                [CSS.containerOpen]: this.opened,
                [CSS.slottedInShell]: this.slottedInShell,
            } }, index.h("calcite-scrim", { key: '16ad63350946bfdc9d93e1de099c35ec4085923f', class: CSS.scrim, onClick: this.handleOutsideClose }), this.renderStyle(), index.h("div", { key: '6bc90f5591d025ab11b9e20460888a5c90079fc4', class: {
                [CSS.modal]: true,
            }, ref: this.setTransitionEl }, index.h("div", { key: 'bb3c7cdcb9aeb984608faf5adc83aeecfb76236b', class: CSS.header }, this.renderCloseButton(), index.h("header", { key: '4c90d6d66e1dfeffb967d14c95b84568be92846d', class: CSS.title }, index.h("slot", { key: '547d39c10dd55af959d9c2595969ad205af4fdcc', name: CSS.header }))), this.renderContentTop(), index.h("div", { key: 'fe344731d2dcde79ef625640f73b585ca278a158', class: {
                [CSS.content]: true,
                [CSS.contentNoFooter]: !this.hasFooter,
            }, ref: (el) => (this.modalContent = el) }, index.h("slot", { key: '2fdbe6fa9a7c424e46db9bc00ad76e9cd8f1d242', name: SLOTS.content })), this.renderContentBottom(), this.renderFooter()))));
    }
    renderFooter() {
