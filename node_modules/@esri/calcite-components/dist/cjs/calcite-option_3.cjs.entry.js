...
const Option = class {
    ...
    //--------------------------------------------------------------------------
    render() {
        return index.h("slot", { key: '30dbf64c7f3e198659e0a96d7ca3cfcf85977e4b' }, this.label);
    }
...
const OptionGroup = class {
    ...
    //--------------------------------------------------------------------------
    render() {
        return (index.h(index.Fragment, { key: '8f313d8117f39af40a697464bc439d380b69263e' }, index.h("div", { key: 'b04f6bd8f1096b3c87417073638d04b0dec6a649' }, this.label), index.h("slot", { key: '092e7c21870bda3b7b6f9039e2c49baad0e161f9' })));
    }
    static get watchers() { return {
        "disabled": ["handlePropChange"],
        "label": ["handlePropChange"]
...
const Select = class {
    ...
    render() {
        const { disabled } = this;
        return (index.h(index.Host, { key: '7ad7273616547303b16b4acb5a0a7e74e6b70103' }, index.h(interactive.InteractiveContainer, { key: 'd4f38f4ee1836e7d2ef63b0ee6eb94e00ca363a5', disabled: disabled }, index.h("div", { key: '8e07dfd9a1ae6a76336229c6111999c1722af48a', class: CSS.wrapper }, index.h("select", { key: 'bb09bb53c0a6fdfd1cf81fcc901e470e4822be1d', "aria-label": label.getLabelText(this), class: CSS.select, disabled: disabled, onChange: this.handleInternalSelectChange, ref: this.storeSelectRef }, index.h("slot", { key: '3efcacc3bdb058e36d10c86bb87da89a1fd93994' })), this.renderChevron(), index.h(form.HiddenFormInputSlot, { key: '02af04d02f83b3542c46601f08a45cac63b3eecd', component: this })), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "value": ["valueHandler"],
