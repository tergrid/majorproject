...
const resources$1 = require('./resources-7dff0197.js');
...
const Panel = class {
    ...
    render() {
        ...
        const panelNode = (index.h("article", { key: 'ef6d443da0ee8f1632ccc2d42212fbcb8aae9c7b', "aria-busy": dom.toAriaBoolean(loading), class: resources.CSS.container, hidden: closed, ref: this.setContainerRef, tabIndex: closable ? 0 : -1 }, this.renderHeaderNode(), this.renderContent(), this.renderContentBottom(), this.renderFooterNode()));
        return (index.h(index.Host, { key: '19de467ff4b2b1a93b66e35f39b8bddea879cfcb', onKeyDown: panelKeyDownHandler }, index.h(interactive.InteractiveContainer, { key: 'b7a1c9cec41545805c36a541d6ae8a0218a66a0a', disabled: disabled }, loading ? index.h("calcite-scrim", { loading: loading }) : null, panelNode)));
    }
