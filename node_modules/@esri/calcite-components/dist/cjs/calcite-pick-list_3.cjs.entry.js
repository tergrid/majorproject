...
const resources = require('./resources-9fc06e6f.js');
...
const PickListGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Fragment, { key: '2b683eccacd3d0721ea6d2a40cbad7e7023f8b1c' }, title ? (index.h(Heading.Heading, { class: resources.CSS$1.heading, level: level }, title)) : null, index.h("slot", { key: '9f3441e5eaba495f97bcef4425fe0e1f6373726f', name: resources.SLOTS$1.parentItem }), index.h("section", { key: '98b9dd92ff222ada37586643048c1e89ec5558e5', class: sectionClasses }, index.h("slot", { key: '947e5f8b6272f831d3ae950a36bc2aa39bace9fa' }))));
    }
    get el() { return index.getElement(this); }
};
...
const PickListItem = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: '85a0571031019b57368a2000567235bd4483a026', disabled: this.disabled }, this.renderIcon(), this.renderActionsStart(), index.h("label", { key: 'c9a58b18d5578310ac9d1f1ac7774712432c8a1d', "aria-label": label, class: resources.CSS.label, onClick: this.pickListClickHandler, onKeyDown: this.pickListKeyDownHandler, ref: (focusEl) => (this.focusEl = focusEl), tabIndex: 0 }, index.h("div", { key: '4efff287c27ac06bec50fb4a5b3e03d31af59ed4', "aria-checked": dom.toAriaBoolean(this.selected), class: resources.CSS.textContainer, role: "menuitemcheckbox" }, index.h("span", { key: '56d9bac1fb6d7625d62e25e82efee682e37bd2b9', class: resources.CSS.title }, label), description ? index.h("span", { class: resources.CSS.description }, description) : null)), this.renderActionsEnd()));
    }
