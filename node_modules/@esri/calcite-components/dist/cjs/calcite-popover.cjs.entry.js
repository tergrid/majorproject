...
const FloatingArrow = require('./FloatingArrow-50d83534.js');
...
const Popover = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e8506c9d3ebc8207a1f247c7b170223c490b1e60', "aria-hidden": dom.toAriaBoolean(hidden), "aria-label": label, "aria-live": "polite", "calcite-hydrated-hidden": hidden, id: this.getId(), role: "dialog" }, index.h("div", { key: 'ebf86df978ed5f949fccd65d7b20816b0ae1e444', class: {
                [floatingUi.FloatingCSS.animation]: true,
                [floatingUi.FloatingCSS.animationActive]: displayed,
            }, ref: this.setTransitionEl }, arrowNode, index.h("div", { key: '3470845888172fdf0e0c6fbe3b0f514ef1d0a231', class: {
                [CSS.hasHeader]: !!heading,
                [CSS.container]: true,
            } }, this.renderHeader(), index.h("div", { key: '7db1c2b89d88ba5641e232e7ef16e1f8edc00c7b', class: CSS.content }, index.h("slot", { key: 'f559c29d7b0d90140c05baed67e7c43b50b9a401' })), !heading ? this.renderCloseButton() : null))));
    }
