...
const RadioButtonGroup = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (index.h(index.Host, { key: '5a94ec3362a9b9f7db1ca45a26e53cf8f1de911b', role: "radiogroup" }, index.h("div", { key: '9f627ec4f22f4c2b56d1133ef14f9268c8e5df62', class: CSS.itemWrapper }, index.h("slot", { key: 'a3d1b1afe48ba0c447319a06e7733f1ab99fb44c' })), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null));
    }
