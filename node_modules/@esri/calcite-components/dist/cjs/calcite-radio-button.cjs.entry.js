...
const RadioButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8f3041ba8734968e9ca661384fe5263ce7a7cc59', onClick: this.clickHandler, onKeyDown: this.handleKeyDown }, index.h(interactive.InteractiveContainer, { key: 'df85d6120f9a1e56cc76c1a113288c8b3e96c3fe', disabled: this.disabled }, index.h("div", { key: '3ce0f9b2d7b3b8cbc8b4f3a150b3aef94609e37f', "aria-checked": dom.toAriaBoolean(this.checked), "aria-label": label.getLabelText(this), class: CSS.container, onBlur: this.onContainerBlur, onFocus: this.onContainerFocus, ref: this.setContainerEl, role: "radio", tabIndex: tabIndex }, index.h("div", { key: '05bb36982a0c97c7dac4f3af93765fc99cef55da', class: "radio" })), index.h(form.HiddenFormInputSlot, { key: '5aec77d3a354d25d9ee49b8255c89c5fdffcc6aa', component: this }))));
    }
