...
const Shell = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: 'dec1862d2e9bfd53e523ad05089d443decbc8b4e' }, this.renderHeader(), this.renderMain(), this.renderFooter(), this.renderPositionedSlots()));
    }
