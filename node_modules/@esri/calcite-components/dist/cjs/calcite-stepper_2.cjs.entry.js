...
const Stepper = class {
    ...
    render() {
        return (index.h(index.Host, { key: '64d0ba01a4c261859d24330a991053e4d11a674d', "aria-label": this.messages.label, role: "region" }, index.h("div", { key: 'f9d6ad9c23d0e184c56d1f0e55646371bf737773', class: { container: true, [CSS$2.singleView]: this.layout === "horizontal-single" }, ref: this.setContainerEl }, this.layout === "horizontal-single" && (index.h("div", { key: '8b3a6eae8e36b5a88ddeeca23e40707b4a846ff9', class: { [CSS$2.stepBarContainer]: true } }, this.items.map((item, index$1) => (index.h(StepBar, { active: index$1 === this.currentActivePosition, complete: item.complete && index$1 !== this.currentActivePosition && !item.error, disabled: item.disabled && index$1 !== this.currentActivePosition, error: item.error && index$1 !== this.currentActivePosition, key: index$1 }))))), this.layout === "horizontal-single" && (index.h("div", { key: 'c8ea14b7ac19b686d2e10300eeeaabeeab5080f0', class: { [CSS$2.actionContainer]: true } }, this.renderAction("start"), this.renderAction("end"))), index.h("slot", { key: 'f1182fb35227c30969addd5890ea9f3906451194', onSlotchange: this.handleDefaultSlotChange }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const StepperItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7e1676213fd9ea5ca92d3ba9448d46f10b03d274', "aria-current": this.selected ? "step" : "false", onClick: this.handleItemClick, onKeyDown: this.keyDownHandler, tabIndex: this.disabled ? -1 : 0 }, index.h(interactive.InteractiveContainer, { key: '5f04c2ff5d5434557f2cd93fb2cbcef74cf11066', disabled: this.disabled }, index.h("div", { key: '1695f8538c9fa37be7a35a8e540a696544b78f96', class: CSS.container }, this.complete && (index.h("span", { key: 'd01e2ed0841fcbd130f35c794d034b8cc60981ab', "aria-live": "polite", class: CSS.visuallyHidden }, this.messages.complete)), index.h("div", { key: '74f3420af394eae3edb8dadd5f04acdbf57ce24b', class: CSS.stepperItemHeader, ref: (el) => (this.headerEl = el), tabIndex: 
            /* additional tab index logic needed because of display: contents */
            this.layout === "horizontal" && !this.disabled ? 0 : null }, this.icon ? this.renderIcon() : null, this.numbered ? (index.h("div", { class: CSS.stepperItemNumber }, this.renderNumbers(), ".")) : null, index.h("div", { key: 'dbdb6b16f627bd603d08e8110b7d14216b6e3d0e', class: CSS.stepperItemHeaderText }, index.h("span", { key: 'db672b9568fc093b87bf95455aa6e2991eec4602', class: CSS.stepperItemHeading }, this.heading), index.h("span", { key: '2d9c14e1dc57c3620911f1b17c18a5c0ba432d87', class: CSS.stepperItemDescription }, this.description))), index.h("div", { key: 'e687eda9cbe53f0bbf9c72e22a0a3e092df40e8e', class: CSS.stepperItemContent }, index.h("slot", { key: '04000d35a912a8fdc19f5edc5e6761a0fbbbf0b8' }))))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
