...
const Switch = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (index.h(index.Host, { key: 'c20adcd3fc9cae797400858f98e67107b03fa9e0', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { key: '4ed4d6a1279a878e9a77ab98df8e4ef28a3de63c', disabled: this.disabled }, index.h("div", { key: '96197c87a50be23dc97c96bac701585301d2f307', "aria-checked": dom.toAriaBoolean(this.checked), "aria-label": label.getLabelText(this), class: CSS.container, ref: this.setSwitchEl, role: "switch", tabIndex: 0 }, index.h("div", { key: 'e11b7ba961982ab310253460fb39ece47e37c012', class: CSS.track }, index.h("div", { key: '42652b1d4cad4ebebb095935530d962225d8dac3', class: CSS.handle })), index.h(form.HiddenFormInputSlot, { key: 'f0bc123cdde232a4aa6ee08056c43f65c804b05d', component: this })))));
    }
