...
const browser = require('./browser-1161b139.js');
...
const Table = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0ad775918a528e0383ae8ac668aaea171e743c50' }, index.h("div", { key: '001fa218604e3f208bc74fe2eb55633c37fb6359', class: CSS.container }, this.selectionMode !== "none" &&
            this.selectionDisplay !== "none" &&
            this.renderSelectionArea(), index.h("div", { key: '3ed54bb7c34347be92c41ac8cb3daa50833b08bc', class: {
                [CSS.bordered]: this.bordered,
                [CSS.striped]: this.striped || this.zebra,
                [CSS.tableContainer]: true,
            } }, index.h("table", { key: 'fdde4e69f98bf70dd39a9a51cc269ced2d0e88b4', "aria-colcount": this.colCount, "aria-multiselectable": this.selectionMode === "multiple", "aria-rowcount": this.allRows?.length, class: { [CSS.tableFixed]: this.layout === "fixed" }, role: this.interactionMode === "interactive" ? "grid" : "table" }, index.h("caption", { key: '10dcd581d09d75e8ecb968e04bba90367b248731', class: CSS.assistiveText }, this.caption), this.renderTHead(), this.renderTBody(), this.renderTFoot())), this.pageSize > 0 && this.renderPaginationArea())));
    }
