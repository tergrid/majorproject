...
const TileSelect = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: 'f70783f8c4dddccf2bfba87de96f4c6072603ae0', disabled: disabled }, index.h("div", { key: 'd982179b5d5e01a1b22110b98338846e32885e0a', class: {
                checked,
                container: true,
            ...
            } }, index.h("div", { key: 'd02b7606cc8d1c9bceb60e6045c1b94ddb94aa47', class: { [CSS.tile]: true, [CSS.tileLargeVisual]: isLargeVisual } }, icon && (index.h("div", { key: 'd9025c18ccdcc05b98366b5222eb7eae937ac351', class: { [CSS.icon]: renderIcon } }, index.h("calcite-icon", { key: '740671b50c6feb1baef2090afc16bad798ed0d58', flipRtl: iconFlipRtl, icon: icon, scale: "l" }))), index.h("div", { key: '719a57afbd608f98ef5b56b3f58f1f475cd4e528', class: CSS.tileContentContainer }, index.h("div", { key: 'fda283b27ad44f0b28f03a79069f6ccc3e109c82', class: CSS.tileContent }, heading && index.h("div", { key: '3136fc30f4cc38eaac1ed2643ed08ae1f9d68572', class: CSS.tileHeading }, heading), description && index.h("div", { key: '814ec2da7cce51f36da4da10c0740697d710a715', class: CSS.tileDescription }, description)))), index.h("slot", { key: 'f1ef1b66654864ab61c7eca65c2698ad61707a5a' }))));
    }
...
const TileSelectGroup = class {
    ...
    render() {
        return (index.h(interactive.InteractiveContainer, { key: '0a940853ee584166188e6c553db579ec7dcae268', disabled: this.disabled }, index.h("slot", { key: 'f0ee847dc3b6896ff245df23d6b76ce5816f482d' })));
    }
    get el() { return index.getElement(this); }
};
