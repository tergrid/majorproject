...
const Tile = class {
    ...
    render() {
        const { disabled } = this;
        return (index.h(interactive.InteractiveContainer, { key: '7e1367887f1ab8c6dedb788d9c3f83625202c982', disabled: disabled }, this.href ? (index.h("calcite-link", { disabled: disabled, href: this.href }, this.renderTile())) : (this.renderTile())));
    }
