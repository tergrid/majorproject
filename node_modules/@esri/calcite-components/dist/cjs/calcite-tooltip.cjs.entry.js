...
const Tooltip = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ae49e09ed0bff6db00b92e8bb34d518fdc1a3823', "aria-hidden": dom.toAriaBoolean(hidden), "aria-label": label, "aria-live": "polite", "calcite-hydrated-hidden": hidden, id: this.getId(), role: "tooltip" }, index.h("div", { key: '5445d83bd2e88f0e5929de80b8c835aa2141f58e', class: {
                [floatingUi.FloatingCSS.animation]: true,
                [floatingUi.FloatingCSS.animationActive]: displayed,
            }, ref: this.setTransitionEl }, index.h(FloatingArrow.FloatingArrow, { key: '22eb13880745a1a5caf9ef4fcc4d6a8e62003347', floatingLayout: floatingLayout, ref: (arrowEl) => (this.arrowEl = arrowEl) }), index.h("div", { key: '6de4a60c6cae94cbd4550d98a9597c01fef66fc6', class: CSS.container }, index.h("slot", { key: '06115e9594d7561cd03f92ce5d0aa08ae26254ab' })))));
    }
