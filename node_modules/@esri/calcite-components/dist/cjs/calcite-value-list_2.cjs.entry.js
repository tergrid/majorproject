...
const sortableComponent = require('./sortableComponent-d432982a.js');
...
const ValueList = class {
    ...
    render() {
        return (index.h(resources.List, { key: '2ea5ebbc75e1535376ac43da1fded54ca476978d', onBlur: this.handleBlur, onFocusin: this.handleFocusIn, onKeyDown: this.keyDownHandler, props: this }));
    }
