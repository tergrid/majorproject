...
export class ActionPad {
    ...
    renderBottomActionGroup() {
        ...
        const expandToggleNode = !expandDisabled ? (h(ExpandToggle, { collapseText: messages.collapse, el: el, expandText: messages.expand, expanded: expanded, position: position, ref: this.setExpandToggleRef, scale: scale, toggle: toggleExpand, tooltip: this.expandTooltip })) : null;
    ...
    render() {
        return (h(Host, { key: 'd5ac59815e47872f3e04d9147872fade94a82c22', onCalciteActionMenuOpen: this.actionMenuOpenHandler }, h("div", { key: '06adf208d6986d6f6414c9526aa9bcd2f4fe7bd9', class: CSS.container }, h("slot", { key: '1f9e4601ef72cd5a19bbfd2b5d4337b6390597f5', onSlotchange: this.handleDefaultSlotChange }), this.renderBottomActionGroup())));
    }
