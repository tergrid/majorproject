...
export class CalciteNavigationUser {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (h(Host, { key: '0a297a43be0898d70e100ca342f3aeb82f98bfa0' }, h("button", { key: '094a7ac4df90a0bfcbc0de0276117915d9bbc5f0', "aria-label": this.label, class: CSS.button }, h("calcite-avatar", { key: 'cc31ec156e9781635a7f256095a5790b6e4487fc', "full-name": this.fullName, label: this.label, thumbnail: this.thumbnail, "user-id": this.userId, username: this.username }), (this.fullName || this.username) && !this.textDisabled && (h("div", { key: 'e2fab2944dd91fe6d31a29235458d4e837f4873b', class: CSS.textContainer }, this.fullName && (h("span", { class: CSS.fullName, key: CSS.fullName }, this.fullName)), this.username && (h("span", { class: CSS.username, key: CSS.username }, this.username)))))));
    }
