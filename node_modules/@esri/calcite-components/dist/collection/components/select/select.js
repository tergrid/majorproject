...
export class Select {
    ...
    render() {
        const { disabled } = this;
        return (h(Host, { key: '7ad7273616547303b16b4acb5a0a7e74e6b70103' }, h(InteractiveContainer, { key: 'd4f38f4ee1836e7d2ef63b0ee6eb94e00ca363a5', disabled: disabled }, h("div", { key: '8e07dfd9a1ae6a76336229c6111999c1722af48a', class: CSS.wrapper }, h("select", { key: 'bb09bb53c0a6fdfd1cf81fcc901e470e4822be1d', "aria-label": getLabelText(this), class: CSS.select, disabled: disabled, onChange: this.handleInternalSelectChange, ref: this.storeSelectRef }, h("slot", { key: '3efcacc3bdb058e36d10c86bb87da89a1fd93994' })), this.renderChevron(), h(HiddenFormInputSlot, { key: '02af04d02f83b3542c46601f08a45cac63b3eecd', component: this })), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
