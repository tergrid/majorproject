...
const Block = /*@__PURE__*/ proxyCustomElement(class Block extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '2b4bc16c96ad283fc0cb7fdc962d45f9047d2025' }, h(InteractiveContainer, { key: '3d846b4884a822a8e4d1550324c1e60d02567622', disabled: this.disabled }, h("article", { key: 'aba63d45e2c228f297abb31963c63f1e4bc980c9', "aria-busy": toAriaBoolean(loading), class: {
                [CSS.container]: true,
            } }, headerNode, h("section", { key: 'a83029c21f41ea740a1a5e11e42a0613d5fd77cc', "aria-labelledby": IDS.toggle, class: CSS.content, hidden: !open, id: IDS.content, ref: this.setTransitionEl }, this.renderScrim())))));
    }
