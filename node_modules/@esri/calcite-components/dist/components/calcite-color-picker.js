...
const ColorPicker = /*@__PURE__*/ proxyCustomElement(class ColorPicker extends HTMLElement {
    ...
    render() {
        ...
        return (h(InteractiveContainer, { key: '5f347cb136350e7661b7b479ee86a16bb85414c3', disabled: this.disabled }, h("div", { key: '0294cbc1d16db228c22a2ae1bd061d9a683c1378', class: CSS.container }, h("div", { key: 'f7531da7e77293d52f5f8220443258e40f07f2d3', class: CSS.controlAndScope }, h("canvas", { key: '21bd0117fa182a4b40b092a905dee76714b94c78', class: CSS.colorField, onPointerDown: this.handleColorFieldPointerDown, ref: this.initColorField }), h("div", { key: 'b5c64766b5e4bc4e7971dfe64f07c43c8c9666f8', "aria-label": vertical ? messages.value : messages.saturation, "aria-valuemax": vertical ? HSV_LIMITS.v : HSV_LIMITS.s, "aria-valuemin": "0", "aria-valuenow": (vertical ? color?.saturationv() : color?.value()) || "0", class: { [CSS.scope]: true, [CSS.colorFieldScope]: true }, onKeyDown: this.handleColorFieldScopeKeyDown, ref: this.storeColorFieldScope, role: "slider", style: {
                top: `${adjustedColorFieldScopeTop || 0}px`,
                left: `${adjustedColorFieldScopeLeft || 0}px`,
            }, tabindex: "0" })), h("div", { key: '2a821875af0e6b0ac8aefc3415c6f2f23bae2cae', class: CSS.previewAndSliders }, h("calcite-color-picker-swatch", { key: 'ec3f7dd7b0ffc702f2aba80a7b7e270c6dc95dbd', class: CSS.preview, color: selectedColorInHex, scale: "l" }), h("div", { key: '82323c8fb8781d1be62f5c9e15ab491593751af8', class: CSS.sliders }, h("div", { key: '11702f0c4d40377e89d1c3ec6b5b0ba0f166b034', class: CSS.controlAndScope }, h("canvas", { key: 'c175af1d7e64f535cc2748d86fc882bf8436729d', class: { [CSS.slider]: true, [CSS.hueSlider]: true }, onPointerDown: this.handleHueSliderPointerDown, ref: this.initHueSlider }), h("div", { key: 'c16a4a0eaa7dd4cbcf7ac3faf589afd11b9a77e7', "aria-label": messages.hue, "aria-valuemax": HSV_LIMITS.h, "aria-valuemin": "0", "aria-valuenow": color?.round().hue() || DEFAULT_COLOR.round().hue(), class: { [CSS.scope]: true, [CSS.hueScope]: true }, onKeyDown: this.handleHueScopeKeyDown, ref: this.storeHueScope, role: "slider", style: {
