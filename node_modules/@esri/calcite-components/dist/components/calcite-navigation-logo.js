...
const CalciteNavigationLogo$1 = /*@__PURE__*/ proxyCustomElement(class CalciteNavigationLogo extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '1731672dced8604741302aad95374e7ce48cfadb' }, h("a", { key: 'f1b449a3a2b46c1be2c6910801c4e0536e62cf86', class: CSS.anchor, href: this.href, rel: this.rel, target: this.target }, thumbnail && h("img", { key: 'f9bbdb365aab019314c59c62ac915c37f4f05782', alt: this.label || "", class: CSS.image, src: thumbnail }), this.icon && this.renderIcon(), this.renderHeaderContent())));
    }
