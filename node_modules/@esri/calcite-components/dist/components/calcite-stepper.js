...
const Stepper = /*@__PURE__*/ proxyCustomElement(class Stepper extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '64d0ba01a4c261859d24330a991053e4d11a674d', "aria-label": this.messages.label, role: "region" }, h("div", { key: 'f9d6ad9c23d0e184c56d1f0e55646371bf737773', class: { container: true, [CSS$1.singleView]: this.layout === "horizontal-single" }, ref: this.setContainerEl }, this.layout === "horizontal-single" && (h("div", { key: '8b3a6eae8e36b5a88ddeeca23e40707b4a846ff9', class: { [CSS$1.stepBarContainer]: true } }, this.items.map((item, index) => (h(StepBar, { active: index === this.currentActivePosition, complete: item.complete && index !== this.currentActivePosition && !item.error, disabled: item.disabled && index !== this.currentActivePosition, error: item.error && index !== this.currentActivePosition, key: index }))))), this.layout === "horizontal-single" && (h("div", { key: 'c8ea14b7ac19b686d2e10300eeeaabeeab5080f0', class: { [CSS$1.actionContainer]: true } }, this.renderAction("start"), this.renderAction("end"))), h("slot", { key: 'f1182fb35227c30969addd5890ea9f3906451194', onSlotchange: this.handleDefaultSlotChange }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
