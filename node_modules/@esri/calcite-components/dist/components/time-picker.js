...
const TimePicker = /*@__PURE__*/ proxyCustomElement(class TimePicker extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: 'a14cbeb1861fce5acdb6c06210c62d1a60e2c7e7', class: {
            ...
            }, onClick: this.hourUpClickHandler, role: "button" }, h("calcite-icon", { key: 'd1dfd48891fb26a56873ec597ec9822b2ae9cf5e', icon: "chevron-up", scale: iconScale })), h("span", { key: '703fddfc787993df85ada887bf4c70042e845651', "aria-label": this.messages.hour, "aria-valuemax": "23", "aria-valuemin": "1", "aria-valuenow": (hourIsNumber && parseInt(this.hour)) || "0", "aria-valuetext": this.hour, class: {
                [CSS.input]: true,
                [CSS.hour]: true,
                [CSS.inputFocus]: this.activeEl && this.activeEl === this.hourEl,
            }, onClick: this.inputClickHandler, onFocus: this.focusHandler, onKeyDown: this.hourKeyDownHandler, ref: this.setHourEl, role: "spinbutton", tabIndex: 0 }, this.localizedHour || "--"), h("span", { key: '213873cc6df77fb4a4da2fdd146c18b317f8cac0', "aria-label": this.messages.hourDown, class: {
                [CSS.button]: true,
                [CSS.buttonHourDown]: true,
                [CSS.buttonBottomLeft]: true,
            }, onClick: this.hourDownClickHandler, role: "button" }, h("calcite-icon", { key: 'f56620ff6b98898301cb44269986d1cea0c0d50b', icon: "chevron-down", scale: iconScale }))), h("span", { key: '65694936b1fd9882ea8d7b157cee4982209fa27f', class: CSS.delimiter }, this.localizedHourSuffix), h("div", { key: '37f5b8bfaa4138aa8637bae2be700858d7357687', class: CSS.column, role: "group" }, h("span", { key: '8f6eb30fe2656127a7d3474a32ac30c297ac6987', "aria-label": this.messages.minuteUp, class: {
                [CSS.button]: true,
                [CSS.buttonMinuteUp]: true,
            }, onClick: this.minuteUpClickHandler, role: "button" }, h("calcite-icon", { key: '3f0ab4b6f0c164bd6c3ca83e9c2e6580299a3a71', icon: "chevron-up", scale: iconScale })), h("span", { key: '28b84074cfd72609d76ffaea1889bfdd9c5a2b3a', "aria-label": this.messages.minute, "aria-valuemax": "12", "aria-valuemin": "1", "aria-valuenow": (minuteIsNumber && parseInt(this.minute)) || "0", "aria-valuetext": this.minute, class: {
                [CSS.input]: true,
                [CSS.minute]: true,
                [CSS.inputFocus]: this.activeEl && this.activeEl === this.minuteEl,
            }, onClick: this.inputClickHandler, onFocus: this.focusHandler, onKeyDown: this.minuteKeyDownHandler, ref: this.setMinuteEl, role: "spinbutton", tabIndex: 0 }, this.localizedMinute || "--"), h("span", { key: '30d5ab5f073e6ae03fdf4f1228b1b10d627bdf10', "aria-label": this.messages.minuteDown, class: {
                [CSS.button]: true,
                [CSS.buttonMinuteDown]: true,
            }, onClick: this.minuteDownClickHandler, role: "button" }, h("calcite-icon", { key: '88ea98f99e5b41ef9b2a1919b4e66142c84ea31b', icon: "chevron-down", scale: iconScale }))), this.showSecond && h("span", { key: 'd50f7950df83e6a11d0979c6aac6e88ddcb5fcaf', class: CSS.delimiter }, this.localizedMinuteSuffix), this.showSecond && (h("div", { key: 'c93de10979377c49b66c26e49d3bfa3df618c582', class: CSS.column, role: "group" }, h("span", { key: '6bb2b948b6246d7520e5e031b52d8188b1a3fd72', "aria-label": this.messages.secondUp, class: {
                [CSS.button]: true,
                [CSS.buttonSecondUp]: true,
            }, onClick: this.secondUpClickHandler, role: "button" }, h("calcite-icon", { key: '67a2d526cdbc02e28441c961a9bd5760a2d28382', icon: "chevron-up", scale: iconScale })), h("span", { key: '2ea6c88de974575f886503b46857ee1ef69c2cc0', "aria-label": this.messages.second, "aria-valuemax": "59", "aria-valuemin": "0", "aria-valuenow": (secondIsNumber && parseInt(this.second)) || "0", "aria-valuetext": this.second, class: {
                [CSS.input]: true,
                [CSS.second]: true,
                [CSS.inputFocus]: this.activeEl && this.activeEl === this.secondEl,
            }, onClick: this.inputClickHandler, onFocus: this.focusHandler, onKeyDown: this.secondKeyDownHandler, ref: this.setSecondEl, role: "spinbutton", tabIndex: 0 }, this.localizedSecond || "--"), h("span", { key: 'd3a86592230284a1e68e10bb13437353cfcba1f5', "aria-label": this.messages.secondDown, class: {
                [CSS.button]: true,
                [CSS.buttonSecondDown]: true,
            }, onClick: this.secondDownClickHandler, role: "button" }, h("calcite-icon", { key: '7dcb9aef452ec2820d966e299b29af5934054d54', icon: "chevron-down", scale: iconScale })))), this.showFractionalSecond && (h("span", { key: 'da9573b772437ef10fb7f7322c806400e72d56cc', class: CSS.delimiter }, this.localizedDecimalSeparator)), this.showFractionalSecond && (h("div", { key: '2af76ac59390d31e9a04eee3b9982f3a19209db5', class: CSS.column, role: "group" }, h("span", { key: '937d5987f32e63db4ea97c212059c7dcd01d6dc0', "aria-label": this.messages.fractionalSecondUp, class: {
                [CSS.button]: true,
                [CSS.buttonFractionalSecondUp]: true,
            }, onClick: this.fractionalSecondUpClickHandler, role: "button" }, h("calcite-icon", { key: 'ade2c358a4978cc27b8fa69497f7c6ed6b55a791', icon: "chevron-up", scale: iconScale })), h("span", { key: 'ccfa71b8097d3d7d0a124172a2d505e61a131321', "aria-label": this.messages.fractionalSecond, "aria-valuemax": "999", "aria-valuemin": "1", "aria-valuenow": (fractionalSecondIsNumber && parseInt(this.fractionalSecond)) || "0", "aria-valuetext": this.localizedFractionalSecond, class: {
                [CSS.input]: true,
                [CSS.fractionalSecond]: true,
                [CSS.inputFocus]: this.activeEl && this.activeEl === this.fractionalSecondEl,
            }, onClick: this.inputClickHandler, onFocus: this.focusHandler, onKeyDown: this.fractionalSecondKeyDownHandler, ref: this.setFractionalSecondEl, role: "spinbutton", tabIndex: 0 }, this.localizedFractionalSecond || "--"), h("span", { key: '0bca03719ade016a99af7f2e8f4ac7167c75fca4', "aria-label": this.messages.fractionalSecondDown, class: {
                [CSS.button]: true,
                [CSS.buttonFractionalSecondDown]: true,
            }, onClick: this.fractionalSecondDownClickHandler, role: "button" }, h("calcite-icon", { key: 'ed06216b19f3bbc4a4d813e8de4fec44573a2476', icon: "chevron-down", scale: iconScale })))), this.localizedSecondSuffix && (h("span", { key: '025990771a02644aa5bbc85a12f0d45accd60831', class: CSS.delimiter }, this.localizedSecondSuffix)), showMeridiem && (h("div", { key: '9f4b1c6e87825db6c48950709ae607108cbcfa13', class: {
                [CSS.column]: true,
                [CSS.meridiemStart]: this.meridiemOrder === 0,
            }, role: "group" }, h("span", { key: 'b27554040f55ad75b9e594f5f3a37e1854e66f86', "aria-label": this.messages.meridiemUp, class: {
                [CSS.button]: true,
                [CSS.buttonMeridiemUp]: true,
                [CSS.buttonTopRight]: true,
            }, onClick: this.meridiemUpClickHandler, role: "button" }, h("calcite-icon", { key: 'de36bf1c89facc28cd30781a039302ee65b43bd1', icon: "chevron-up", scale: iconScale })), h("span", { key: '9bc188238ba5b800e1d3348d5072d9663a8ca4d9', "aria-label": this.messages.meridiem, "aria-valuemax": "2", "aria-valuemin": "1", "aria-valuenow": (this.meridiem === "PM" && "2") || "1", "aria-valuetext": this.meridiem, class: {
                [CSS.input]: true,
                [CSS.meridiem]: true,
                [CSS.inputFocus]: this.activeEl && this.activeEl === this.meridiemEl,
            }, onClick: this.inputClickHandler, onFocus: this.focusHandler, onKeyDown: this.meridiemKeyDownHandler, ref: this.setMeridiemEl, role: "spinbutton", tabIndex: 0 }, this.localizedMeridiem || "--"), h("span", { key: '81e60f60f2b9daa8b1123c69834bb7a61702dabb', "aria-label": this.messages.meridiemDown, class: {
                [CSS.button]: true,
                [CSS.buttonMeridiemDown]: true,
                [CSS.buttonBottomRight]: true,
            }, onClick: this.meridiemDownClickHandler, role: "button" }, h("calcite-icon", { key: 'ad319248fd32601a11471451d344387a612302a3', icon: "chevron-down", scale: iconScale }))))));
    }
