 ...
 * v2.9.0
 */
import { f as forceUpdate, h } from './index-2fab6cb8.js';
import { g as getElementDir } from './dom-acbb9e0d.js';
import { S as SLOTS$1 } from './resources-0468a7d4.js';
import { S as SLOTS } from './resources-59ed535c.js';
...
const ExpandToggle = ({ expanded, expandText, collapseText, toggle, el, position, tooltip, ref, scale, }) => {
    ...
    const actionNode = (h("calcite-action", { icon: expanded ? expandIcon : collapseIcon, onClick: toggle, ref: (referenceElement) => setTooltipReference({ tooltip, referenceElement, expanded, ref }), scale: scale, text: text, textEnabled: expanded, title: !expanded && !tooltip ? text : null }));
    return actionNode;
};
...
//# sourceMappingURL=ExpandToggle-557e2eb2.js.map