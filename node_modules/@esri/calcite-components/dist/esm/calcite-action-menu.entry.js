 ...
 * v2.9.0
 */
import { r as registerInstance, c as createEvent, h, F as Fragment, g as getElement } from './index-2fab6cb8.js';
import { g as getRoundRobinIndex } from './array-99c8f5d9.js';
import { t as toAriaBoolean, d as focusElement } from './dom-acbb9e0d.js';
...
import { a as activeAttr, C as CSS, I as ICONS, S as SLOTS } from './resources-59ed535c.js';
...
const ActionMenu = class {
    ...
    render() {
        return (h(Fragment, { key: '2e60f0bcf41f683c77fe93d6f776fb1e9ff9f9a7' }, this.renderMenuButton(), this.renderMenuItems(), h("slot", { key: 'e9d8dac34c46653b17c012ab01ed2c7bea3938ba', name: SLOTS.tooltip, onSlotchange: this.updateTooltip })));
    }
