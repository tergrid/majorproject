...
import { b as slotChangeHasAssignedElement, t as toAriaBoolean, e as getSlotted, h as setRequestedIcon } from './dom-acbb9e0d.js';
...
import { N as NumberStringFormat, c as connectLocalized, d as disconnectLocalized } from './locale-10002228.js';
...
const Alert = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'ea81bb8c414a682356d9c2a839df57b73fd4de1e', "aria-hidden": toAriaBoolean(hidden), "aria-label": label, "calcite-hydrated-hidden": hidden, role: role }, h("div", { key: '3d166368d33d7b540e8a9bf2f0c7643f9a774e6c', class: {
                [CSS.container]: true,
                [CSS.containerQueued]: queued,
                [`${CSS.container}--${placement}`]: true,
                [CSS.containerSlottedInShell]: this.slottedInShell,
            }, onPointerEnter: this.autoClose && this.autoCloseTimeoutId ? this.handleMouseOver : null, onPointerLeave: this.autoClose && this.autoCloseTimeoutId ? this.handleMouseLeave : null, ref: this.setTransitionEl }, effectiveIcon && this.renderIcon(effectiveIcon), h("div", { key: '5a761dc8f4158245573cd4ca98fc61396cd9e82c', class: CSS.textContainer }, h("slot", { key: 'd4338d3c7ffb8a9f24c184f0c94becada6bd0198', name: SLOTS.title }), h("slot", { key: '56aa7f1d6b1e9a276f24c586c2acafb3b3cc1c7f', name: SLOTS.message }), h("slot", { key: 'd8844321b222a62be090d9b87487fe270fa76c3e', name: SLOTS.link })), this.renderActionsEnd(), hasQueuedAlerts ? this.renderQueueCount() : null, this.renderCloseButton(), open && !queued && autoClose ? h("div", { class: CSS.dismissProgress }) : null)));
    }
    renderCloseButton() {
        return (h("button", { "aria-label": this.messages.close, class: CSS.close, key: "close", onClick: this.closeAlert, ref: (el) => (this.closeButton = el), type: "button" }, h("calcite-icon", { icon: "x", scale: getIconScale(this.scale) })));
    }
    renderQueueCount() {
