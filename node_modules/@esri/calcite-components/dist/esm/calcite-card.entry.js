...
import { b as slotChangeHasAssignedElement, e as getSlotted, t as toAriaBoolean } from './dom-acbb9e0d.js';
...
import { c as componentFocusable, a as setComponentLoaded, s as setUpLoadableComponent } from './loadable-d9ec45c6.js';
    ...
    render() {
        ...
        const role = this.selectionMode === "multiple"
            ...
            : this.selectionMode !== "none"
                ? "radio"
                : undefined;
        return (h(Host, { key: '8fa8f2d7e3ff03d01d746fd00236958a910cc60b' }, h(InteractiveContainer, { key: 'f1a65dcd2389a060c9de2ab0d9ee9b4ab23609f9', disabled: this.disabled }, h("div", { key: 'ea25c5a5306fd1829192562d13c8ddf3be52399a', "aria-checked": this.selectionMode !== "none" ? toAriaBoolean(this.selected) : undefined, "aria-disabled": this.disabled, "aria-label": this.label, class: { [CSS.contentWrapper]: true, inline: thumbnailInline }, onClick: this.cardBodyClickHandler, onKeyDown: this.keyDownHandler, ref: (el) => (this.containerEl = el), role: role, tabIndex: !this.selectable || this.disabled ? 0 : -1 }, this.loading ? (h("div", { "aria-live": "polite", class: "calcite-card-loader-container" }, h("calcite-loader", { label: this.messages.loading }))) : null, thumbnailStart && this.renderThumbnail(), h("section", { key: '8d05974e84e7bcb009f4865149e70cc4e48ef8d9', "aria-busy": toAriaBoolean(this.loading), class: { [CSS.container]: true } }, this.renderHeader(), h("div", { key: 'd15b62083fe0fd62b3e64cf86f9d42943cbe4665', class: {
                [CSS.cardContent]: true,
                [CSS.hasSlottedContent]: this.hasContent,
            } }, h("slot", { key: '13471e2cc8916e32fa8cb168577b1bd0d6c51814', onSlotchange: this.handleDefaultSlotChange })), this.renderFooter()), !thumbnailStart && this.renderThumbnail()))));
    }
