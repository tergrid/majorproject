...
import { s as slotChangeGetAssignedElements, k as focusElementInGroup, t as toAriaBoolean, g as getElementDir, A as whenAnimationDone } from './dom-acbb9e0d.js';
...
import { g as getRoundRobinIndex } from './array-99c8f5d9.js';
...
const Carousel = class {
    ...
    render() {
        ...
        return (h(Host, { key: '2b23a26497312fd612f485c992fb7b9c8cdbb996' }, h(InteractiveContainer, { key: '7785faa3c6d065644f7629277d16be3165e1c576', disabled: this.disabled }, h("div", { key: '2bfbfdb794a699d387009c69a47d25e384dbf179', "aria-label": this.label, "aria-live": this.playing ? "off" : "polite", "aria-roledescription": this.messages.carousel, class: {
                [CSS$1.container]: true,
                [CSS$1.containerOverlaid]: this.controlOverlay,
                [CSS$1.containerEdged]: this.arrowType === "edge",
            }, onFocusin: this.handleFocusIn, onFocusout: this.handleFocusOut, onKeyDown: this.containerKeyDownHandler, onMouseEnter: this.handleMouseIn, onMouseLeave: this.handleMouseOut, ref: this.storeContainerRef, role: "group", tabIndex: 0 }, h("section", { key: '56ec54ffe2e77efc01d566e4657f890e0c2276fc', class: {
            ...
            ref: this.storeItemContainerRef }, h("slot", { key: '6f58f05da06d1a919c6a2607b8853f26cf8effea', onSlotchange: this.handleSlotChange })), this.items.length > 1 && this.renderPaginationArea(), this.arrowType === "edge" && this.renderArrow("previous"), this.arrowType === "edge" && this.renderArrow("next")))));
    }
