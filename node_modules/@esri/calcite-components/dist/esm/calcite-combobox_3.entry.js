 ...
 * v2.9.0
 */
import { h, r as registerInstance, c as createEvent, H as Host, g as getElement } from './index-2fab6cb8.js';
import { c as calciteSize48 } from './core-03ded412.js';
import { f as filter } from './filter-9dd7ca82.js';
import { B as nodeListToArray, D as getElementWidth, E as getTextWidth, t as toAriaBoolean, e as getSlotted } from './dom-acbb9e0d.js';
import { d as defaultMenuPlacement, f as filterComputedPlacements, c as connectFloatingUI, r as reposition, a as disconnectFloatingUI, F as FloatingCSS } from './floating-ui-734b7a5a.js';
import { s as submitForm, c as connectForm, a as afterConnectDefaultValueSet, d as disconnectForm, H as HiddenFormInputSlot } from './form-1928b513.js';
...
import { b as componentLoaded, c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-d9ec45c6.js';
...
import { g as getIconScale, a as componentOnReady } from './component-e0450ae4.js';
...
const Combobox = class {
    ...
    renderInput() {
        ...
        return (h("span", { class: {
            ...
            }, disabled: disabled, id: `${inputUidPrefix}${guid}`, key: "input", onFocus: this.comboboxFocusHandler, onInput: this.inputHandler, placeholder: placeholder, readOnly: this.readOnly, ref: (el) => (this.textInput = el), role: "combobox", type: "text" })));
    }
    ...
    render() {
        ...
        return (h(Host, { key: 'bb1ae931350cc82b82895214d069e77443c871bb', onClick: this.comboboxFocusHandler }, h(InteractiveContainer, { key: 'e968cc2ac3f7027debbea8b4af6664829b0f184a', disabled: this.disabled }, h("div", { key: '306c20ccda2f63d412a628920d0f405b35067372', "aria-live": "polite", class: {
                wrapper: true,
        ...
        ], h("label", { key: 'c80ea8769595ef2e51a9c5d552fdcc892d530e67', class: "screen-readers-only", htmlFor: `${inputUidPrefix}${guid}`, id: `${labelUidPrefix}${guid}` }, label), this.renderInput()), !readOnly && isClearable ? (h(XButton, { disabled: this.disabled, key: "close-button", label: this.messages.clear, scale: this.scale })) : null, !readOnly && this.renderChevronIcon()), h("ul", { key: '752d9a454b37fde5058c53c6dffcff74a7855ea3', "aria-labelledby": `${labelUidPrefix}${guid}`, "aria-multiselectable": "true", class: "screen-readers-only", id: `${listboxUidPrefix}${guid}`, role: "listbox", tabIndex: -1 }, this.renderListBoxOptions()), this.renderFloatingUIContainer(), h(HiddenFormInputSlot, { key: '03bbf8ccf12da60caac72660d73460a572190d4b', component: this }), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
