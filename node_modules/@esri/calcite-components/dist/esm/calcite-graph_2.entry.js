 ...
 * v2.9.0
 */
import { r as registerInstance, f as forceUpdate, h, g as getElement, c as createEvent, H as Host } from './index-2fab6cb8.js';
import { g as guid } from './guid-be130516.js';
import { c as createObserver } from './observers-09e0b0a3.js';
import { l as isPrimaryPointerButton, v as intersects } from './dom-acbb9e0d.js';
import { c as connectForm, d as disconnectForm, a as afterConnectDefaultValueSet, H as HiddenFormInputSlot } from './form-1928b513.js';
...
import { n as numberStringFormatter, c as connectLocalized, d as disconnectLocalized } from './locale-10002228.js';
import { d as decimalPlaces, c as clamp } from './math-274e3b1f.js';
...
const Slider = class {
    ...
    render() {
        ...
        return (h(Host, { key: '86ec64bfb42495e7fc927751ad7d2a667b0a625d', id: id, onKeyDown: this.handleKeyDown, onTouchStart: this.handleTouchStart }, h(InteractiveContainer, { key: '842aacebaf4199a088f71b2d2ad7420845cf2629', disabled: this.disabled }, h("div", { key: '364511c370bbf454958accdd4c3084a1c339de22', "aria-label": getLabelText(this), class: {
            ...
            } }, this.renderGraph(), h("div", { key: 'c8366d13976102bdabf6bca85523f295e9713c53', class: CSS.track, ref: this.storeTrackRef }, h("div", { key: '9b078da10285e125f525a8307b52457cd83edf89', class: CSS.trackRange, onPointerDown: this.onTrackPointerDown, style: trackRangePlacementStyles }), h("div", { key: '78fe14d82f98b323d21db80061d64cd348495793', class: CSS.ticks }, this.tickValues.map((tick) => {
        ...
        }))), h("div", { key: '65cd9bb7414a77ba26468a9253369ed0bca0503f', class: CSS.thumbContainer }, minThumb, thumb, h(HiddenFormInputSlot, { key: '83a8c80504e00feb2f5fd584efcdeda53a65c2fd', component: this }))))));
    }
