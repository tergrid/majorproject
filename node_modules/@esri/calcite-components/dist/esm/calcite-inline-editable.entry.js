...
import { e as getSlotted } from './dom-acbb9e0d.js';
...
const InlineEditable = class {
    ...
    render() {
        return (h(InteractiveContainer, { key: '47d77961bb70f18fdb31994c043a013f1400f892', disabled: this.disabled }, h("div", { key: 'c711aa022f759abdc6cc65184fb92d36ccbb629c', class: CSS.wrapper, onClick: this.enableEditingHandler, onKeyDown: this.escapeKeyHandler }, h("div", { key: '21239055816c853b059f700a318fb2b772fb78f5', class: CSS.inputWrapper }, h("slot", { key: 'ca2ce871db7386f9e32264e9555f7a08eac7b9e0' })), h("div", { key: '31cad4378d3f71301dc3b5803a9b34a08e394b3c', class: CSS.controlsWrapper }, h("calcite-button", { key: '942282672ebad6e33cddf76433b490ded2db7dcb', appearance: "transparent", class: CSS.enableEditingButton, disabled: this.disabled, iconStart: "pencil", kind: "neutral", label: this.messages.enableEditing, onClick: this.enableEditingHandler, ref: (el) => (this.enableEditingButton = el), scale: this.scale, style: {
                opacity: this.editingEnabled ? "0" : "1",
                width: this.editingEnabled ? "0" : "inherit",
            }, type: "button" }), this.shouldShowControls && [
            h("div", { key: 'b47f75ed7a102ba84ea82b5dd483bda894c49dc9', class: CSS.cancelEditingButtonWrapper }, h("calcite-button", { key: '590dddf42b7c99f00f4a39af4e2e0eb4adf54697', appearance: "transparent", class: CSS.cancelEditingButton, disabled: this.disabled, iconStart: "x", kind: "neutral", label: this.messages.cancelEditing, onClick: this.cancelEditingHandler, ref: (el) => (this.cancelEditingButton = el), scale: this.scale, type: "button" })),
            h("calcite-button", { key: 'bfbe94acd5313a70558bd6a6ad48127f4b63deed', appearance: "solid", class: CSS.confirmChangesButton, disabled: this.disabled, iconStart: "check", kind: "brand", label: this.messages.confirmChanges, loading: this.loading, onClick: this.confirmChangesHandler, ref: (el) => (this.confirmEditingButton = el), scale: this.scale, type: "button" }),
        ]))));
    }
    //--------------------------------------------------------------------------
    //
