...
import { d as datePartsFromISO, a as datePartsFromLocalizedString, b as dateFromLocalizedString, i as inRange, c as dateToISO, g as getValueAsDateRange, e as dateFromISO, f as getLocaleData, h as dateFromRange } from './utils-9adad0ac.js';
import { t as toAriaBoolean } from './dom-acbb9e0d.js';
import { f as filterComputedPlacements, c as connectFloatingUI, d as defaultMenuPlacement, r as reposition, a as disconnectFloatingUI, F as FloatingCSS } from './floating-ui-734b7a5a.js';
import { s as submitForm, c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './form-1928b513.js';
...
import { n as numberKeys } from './key-ca0ab42f.js';
import { c as connectLabel, d as disconnectLabel } from './label-e5374a88.js';
import { c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-d9ec45c6.js';
import { n as numberStringFormatter, c as connectLocalized, d as disconnectLocalized, b as getSupportedNumberingSystem } from './locale-10002228.js';
...
import { c as connectFocusTrap, d as deactivateFocusTrap, a as activateFocusTrap } from './focusTrapComponent-a6b1239c.js';
import { g as guid } from './guid-be130516.js';
import { a as componentOnReady, g as getIconScale } from './component-e0450ae4.js';
import { V as Validation } from './Validation-3de09d3a.js';
...
const InputDatePicker = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'c913bed40a4d29276ed4d3738e35fa2d6d17ed69', onBlur: this.blurHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { key: '4b880414f337bdbc52a83cc8925220b18610bed1', disabled: this.disabled }, this.localeData && (h("div", { key: 'b5f4fdc2696865f91b31a2bccaf01812680b0453', class: CSS.inputContainer }, h("div", { key: 'f3cd5abd032fffc4b0d035d0ccd8c91b8974d95e', class: CSS.inputWrapper, "data-position": "start", onClick: this.onInputWrapperClick, onPointerDown: this.onInputWrapperPointerDown, ref: this.setStartWrapper }, h("calcite-input-text", { key: '324d01404a24d65963bcc66857748525fc904f74', "aria-autocomplete": "none", "aria-controls": this.dialogId, "aria-describedby": this.placeholderTextId, "aria-expanded": toAriaBoolean(this.open), "aria-haspopup": "dialog", class: {
                [CSS.input]: true,
            ...
            this.renderToggleIcon(this.open && this.focusedInput === "start"), h("span", { key: 'a3becf79e7bcaf182ce4431907c9b3a8055a4b08', "aria-hidden": "true", class: CSS.assistiveText, id: this.placeholderTextId }, "Date Format: ", this.localeData?.placeholder)), h("div", { key: 'eea3c669ea1a7d7748fb44f0d1ad910f5de20bc7', "aria-hidden": toAriaBoolean(!this.open), "aria-label": messages.chooseDate, "aria-live": "polite", "aria-modal": "true", class: {
                [CSS.menu]: true,
                [CSS.menuActive]: this.open,
            }, id: this.dialogId, ref: this.setFloatingEl, role: "dialog" }, h("div", { key: '5ad6e26d8686cfd52e69be91c3ad62a99bd0ec32', class: {
                [CSS.calendarWrapper]: true,
                [CSS.calendarWrapperEnd]: this.focusedInput === "end",
                [FloatingCSS.animation]: true,
                [FloatingCSS.animationActive]: this.open,
            }, ref: this.setTransitionEl }, h("calcite-date-picker", { key: '2f0b5702790624ded01131be71c175a221a41b29', activeDate: this.datePickerActiveDate, activeRange: this.focusedInput, headingLevel: this.headingLevel, max: this.max, maxAsDate: this.maxAsDate, messageOverrides: this.messageOverrides, min: this.min, minAsDate: this.minAsDate, numberingSystem: numberingSystem, onCalciteDatePickerChange: this.handleDateChange, onCalciteDatePickerRangeChange: this.handleDateRangeChange, proximitySelectionDisabled: this.proximitySelectionDisabled, range: this.range, ref: this.setDatePickerRef, scale: this.scale, tabIndex: this.open ? undefined : -1, valueAsDate: this.valueAsDate }))), this.range && this.layout === "horizontal" && (h("div", { key: '94d12d21ee06aa375f1682f8c1eb8972c20faadd', class: CSS.horizontalArrowContainer }, h("calcite-icon", { key: '8b20bb4e9b7277a3bc4a94973404a0d5631c4a04', flipRtl: true, icon: "arrow-right", scale: getIconScale(this.scale) }))), this.range && this.layout === "vertical" && this.scale !== "s" && (h("div", { key: '302bc80a62abc3ba789eba52583d0237612bd20f', class: CSS.verticalArrowContainer }, h("calcite-icon", { key: '80df641d9652a94d33ff0fdbbdc7db155e9d51a1', icon: "arrow-down", scale: getIconScale(this.scale) }))), this.range && (h("div", { key: '85892c1a93693480323d51669d39fccce551ffca', class: CSS.inputWrapper, "data-position": "end", onClick: this.onInputWrapperClick, onPointerDown: this.onInputWrapperPointerDown, ref: this.setEndWrapper }, h("calcite-input-text", { key: 'bb1035f629d77ef98f50798d000d4e1e724276d3', "aria-autocomplete": "none", "aria-controls": this.dialogId, "aria-expanded": toAriaBoolean(this.open), "aria-haspopup": "dialog", class: {
                [CSS.input]: true,
            ...
            this.renderToggleIcon(this.open && this.focusedInput === "end"))))), h(HiddenFormInputSlot, { key: '52bc347d27cb15443c98a99dc03f76e6e0e53339', component: this }), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
