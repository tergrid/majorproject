...
import { h as setRequestedIcon } from './dom-acbb9e0d.js';
...
const InputMessage = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'f7008c19417cc42c784a3f71f811e7ea497398e4', "calcite-hydrated-hidden": hidden }, this.renderIcon(this.requestedIcon), h("slot", { key: '2f15a032a0a51dc475c09fa24ad9789d5d55e49e' })));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
