...
import { g as getElementDir, d as focusElement } from './dom-acbb9e0d.js';
...
const Link = class {
    ...
    render() {
        ...
        const iconStartEl = (h("calcite-icon", { key: '886638422905f1ae6b0cc0a9bcb2e2147067e7c8', class: "calcite-link--icon icon-start", flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: "s" }));
        const iconEndEl = (h("calcite-icon", { key: 'ace6f2ec903c70f16f2ea61114877a239d515c71', class: "calcite-link--icon icon-end", flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: "s" }));
        const Tag = childElType;
        const role = childElType === "span" ? "link" : null;
        const tabIndex = childElType === "span" ? 0 : null;
        return (h(Host, { key: '0377328ab74b27adeb8d65193f7041fc92de340f', role: "presentation" }, h(InteractiveContainer, { key: '5d36a120545f630ec54069e9d71a4171e9b0d777', disabled: this.disabled }, h(Tag, { key: 'bff624c9f7b58e66af31fef464bdc26b4d69937e', class: { [CSS_UTILITY.rtl]: dir === "rtl" },
            /*
          When the 'download' property of type 'boolean | string' is set to true, the value is "".
          This works around that issue for now.
          */
            download: Tag === "a" && (download === "" || download) ? download : null, href: Tag === "a" && this.href, onClick: this.childElClickHandler, ref: this.storeTagRef, rel: Tag === "a" && this.rel, role: role, tabIndex: tabIndex, target: Tag === "a" && this.target }, this.iconStart ? iconStartEl : null, h("slot", { key: 'fdc152ba2dad60b16415159ad82de9208897e26d' }), this.iconEnd ? iconEndEl : null))));
    }
    //--------------------------------------------------------------------------
    //
    //  Events
