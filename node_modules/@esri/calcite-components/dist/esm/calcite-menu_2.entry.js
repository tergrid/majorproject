 ...
 * v2.9.0
 */
import { r as registerInstance, f as forceUpdate, h, H as Host, g as getElement, c as createEvent, F as Fragment } from './index-2fab6cb8.js';
import { s as slotChangeGetAssignedElements, k as focusElementInGroup, d as focusElement, g as getElementDir } from './dom-acbb9e0d.js';
...
const CalciteMenu = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (h(Host, { key: '369a18142b5b22f203aa20f45638a7818b66d69a' }, h("ul", { key: '5de9fb48f9eeb427b1ef220f34326749947b25b5', "aria-label": this.label, role: this.getEffectiveRole() }, h("slot", { key: '96f2b70399a79589a53564bdeb01a50fa753ad7d', onSlotchange: this.handleMenuSlotChange }))));
    }
