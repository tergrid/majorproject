...
import { a as afterConnectDefaultValueSet, c as connectForm, d as disconnectForm } from './form-1928b513.js';
import { g as getSupportedLocale, n as numberStringFormatter, c as connectLocalized, d as disconnectLocalized } from './locale-10002228.js';
import { v as intersects } from './dom-acbb9e0d.js';
    ...
    render() {
        ...
        const valueText = valueLabelType === "percent"
            ...
            : unitLabel
                ? textUnitLabel
                : undefined;
        return (h(Host, { key: '37b481bf217dabf031fea5dd71ec3f9feb0a04cf' }, h("div", { key: 'a42279feb58be3052a4874c8c274bf9409e75fd7', "aria-label": label, "aria-valuemax": rangeLabelType === "percent" ? maxPercent : max, "aria-valuemin": rangeLabelType === "percent" ? minPercent : min, "aria-valuenow": valueLabelType === "percent" ? currentPercent : value, "aria-valuetext": valueText, class: {
                [CSS.container]: true,
