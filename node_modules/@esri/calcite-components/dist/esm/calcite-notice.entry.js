...
import { h as setRequestedIcon, e as getSlotted } from './dom-acbb9e0d.js';
...
import { c as connectMessages, d as disconnectMessages, s as setUpMessages, u as updateMessages } from './t9n-b8b9eb22.js';
import { K as KindIcons } from './resources-315fc6fd.js';
...
const Notice = class {
    ...
    render() {
        const { el } = this;
        const closeButton = (h("button", { key: '898b161c8f357e36a623c0a02de98be2cb2c2a73', "aria-label": this.messages.close, class: CSS.close, onClick: this.close, ref: (el) => (this.closeButton = el) }, h("calcite-icon", { key: '258b71c704cbd390cd7fc031bc04a4ea2eef7ee6', icon: "x", scale: getIconScale(this.scale) })));
        const hasActionEnd = getSlotted(el, SLOTS.actionsEnd);
        return (h("div", { key: 'eb7ea8a838d8ea2182e02fba8701dc816dafbc60', class: CSS.container, ref: this.setTransitionEl }, this.requestedIcon ? (h("div", { class: CSS.icon }, h("calcite-icon", { flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: getIconScale(this.scale) }))) : null, h("div", { key: '3ac734d3b085f1c80bfb16b14df7cb8d1b7058cb', class: CSS.content }, h("slot", { key: '2698e3774993b1af1bd93a2955e312705fd22543', name: SLOTS.title }), h("slot", { key: 'b8fb3c294c893ce2edaddf46066a4df45d8832cd', name: SLOTS.message }), h("slot", { key: '01a792e1d41a8d935ddbb04b1eb857b8b88c8882', name: SLOTS.link })), hasActionEnd ? (h("div", { class: CSS.actionsEnd }, h("slot", { name: SLOTS.actionsEnd }))) : null, this.closable ? closeButton : null));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
