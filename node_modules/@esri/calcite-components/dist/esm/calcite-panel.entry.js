...
import { b as slotChangeHasAssignedElement, s as slotChangeGetAssignedElements, f as focusFirstTabbable, t as toAriaBoolean } from './dom-acbb9e0d.js';
...
import { S as SLOTS$1 } from './resources-59ed535c.js';
...
import { S as SLOTS, C as CSS, I as ICONS } from './resources-e9282654.js';
...
const Panel = class {
    ...
    render() {
        ...
        const panelNode = (h("article", { key: 'ef6d443da0ee8f1632ccc2d42212fbcb8aae9c7b', "aria-busy": toAriaBoolean(loading), class: CSS.container, hidden: closed, ref: this.setContainerRef, tabIndex: closable ? 0 : -1 }, this.renderHeaderNode(), this.renderContent(), this.renderContentBottom(), this.renderFooterNode()));
        return (h(Host, { key: '19de467ff4b2b1a93b66e35f39b8bddea879cfcb', onKeyDown: panelKeyDownHandler }, h(InteractiveContainer, { key: 'b7a1c9cec41545805c36a541d6ae8a0218a66a0a', disabled: disabled }, loading ? h("calcite-scrim", { loading: loading }) : null, panelNode)));
    }
