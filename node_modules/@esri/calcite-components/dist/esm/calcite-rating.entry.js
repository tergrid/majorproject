...
import { f as focusFirstTabbable } from './dom-acbb9e0d.js';
...
const Rating = class {
    ...
    render() {
        return (h(Host, { key: 'b6a1c760c1481fce56241eae3099676fa2a2d1a8', onKeyDown: this.handleHostKeyDown, onPointerOut: this.handleRatingPointerOut, onPointerOver: this.handleRatingPointerOver }, h(InteractiveContainer, { key: 'eb630ca68a4ef75fec897a8e3f0ca7ac60ae4359', disabled: this.disabled }, h("span", { key: '700bb5bf1243c14fa108a3be24d5c3046a18f3e7', class: "wrapper" }, h("fieldset", { key: '9e3646d966e303a9368b46d25ccf998250ae31b7', class: "fieldset", disabled: this.disabled }, h("legend", { key: 'c6f0c10d17585d912c4ce3d64fdedf839074aad1', class: "visually-hidden" }, this.messages.rating), this.starsMap.map(({ average, checked, fraction, hovered, id, partial, selected, value, tabIndex, }) => {
        ...
        }), (this.count || this.average) && this.showChip ? (h("calcite-chip", { scale: this.scale, value: this.count?.toString() }, !!this.average && h("span", { class: "number--average" }, this.average.toString()), !!this.count && h("span", { class: "number--count" }, "(", this.count?.toString(), ")"))) : null), h(HiddenFormInputSlot, { key: '97a7c9889d8da42def0303697c185f9e6b656bbb', component: this })))));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
