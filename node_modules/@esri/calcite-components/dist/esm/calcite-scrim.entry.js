...
import { y as slotChangeHasContent } from './dom-acbb9e0d.js';
...
const Scrim = class {
    ...
    render() {
        ...
        return (h("div", { key: '8da71202fdcfc4d149c91d99870c2be6254baecd', class: CSS.scrim }, loading ? (h("calcite-loader", { label: messages.loading, ref: this.storeLoaderEl, scale: this.loaderScale })) : null, h("div", { key: '893fff6ab8f12415f79cc1a51831029a25215523', class: CSS.content, hidden: !hasContent }, h("slot", { key: '08f17320892c630d53a80f5853299f4d7cc72a7e', onSlotchange: this.handleDefaultSlotChange }))));
    }
    getScale(size) {
