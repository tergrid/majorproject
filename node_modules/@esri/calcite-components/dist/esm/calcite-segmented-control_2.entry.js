...
import { g as getElementDir, y as slotChangeHasContent, t as toAriaBoolean } from './dom-acbb9e0d.js';
import { a as afterConnectDefaultValueSet, c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './form-1928b513.js';
...
const SegmentedControl = class {
    ...
    render() {
        return (h(Host, { key: '50faa0d049d2f0bcae98d8736280e995fc176b0f', onClick: this.handleClick, role: "radiogroup" }, h("div", { key: '070e333887507f0b1ceaee80f670ad858322a217', class: CSS$1.itemWrapper }, h(InteractiveContainer, { key: '580f183a1e8e53e09067806abd5b0bfde52a4f3b', disabled: this.disabled }, h("slot", { key: '8f02a31ad01304b3fbd970a1801721102607d280' }), h(HiddenFormInputSlot, { key: '5e4a2dea48865c02308ada4acfd1e89972e5a78b', component: this }))), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null));
    }
...
const SegmentedControlItem = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'cccfab9b2bafbd943d4130299f9e2c1bff945a94', "aria-checked": toAriaBoolean(checked), "aria-label": value, role: "radio" }, h("label", { key: 'f406eac31751d139fb4b51ba42dbe907d6560a7a', class: {
                [CSS.label]: true,
