...
import { w as ensureId, g as getElementDir, f as focusFirstTabbable } from './dom-acbb9e0d.js';
...
const Sheet = class {
    ...
    render() {
        ...
        return (h(Host, { key: '63e321ecb08bf8d274ed051308ac0a641f92feba', "aria-describedby": this.contentId, "aria-label": this.label, "aria-modal": "true", role: "dialog" }, h("div", { key: '7b05d963fc37d3e72cc9eaa5a391c4b72e30a322', class: {
            ...
            } }, h("calcite-scrim", { key: '4a449289c1ebbaee0ebab426b50f2fe4799da402', class: CSS.scrim, onClick: this.handleOutsideClose }), h("div", { key: 'b43bad1af599d02c40ebe17b89f28f55d2602add', class: {
                [CSS.content]: true,
            }, ref: this.setTransitionEl }, h("slot", { key: '78faab4b2a5558175afbe69d53da438ba3957bf9' })))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
