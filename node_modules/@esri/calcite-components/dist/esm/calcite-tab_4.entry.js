 ...
 * v2.9.0
 */
import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, e as readTask, F as Fragment } from './index-2fab6cb8.js';
import { B as nodeListToArray, k as focusElementInGroup, g as getElementDir, C as filterDirectChildren, t as toAriaBoolean } from './dom-acbb9e0d.js';
import { g as guid } from './guid-be130516.js';
import { a as calciteSize24, b as calciteSize32, d as calciteSize44 } from './core-03ded412.js';
...
import { c as connectInteractive, d as disconnectInteractive, I as InteractiveContainer, u as updateHostInteraction } from './interactive-fe61fef1.js';
...
const TabTitle = class {
    ...
    render() {
        ...
        return (h(Host, { key: '532a18e093cd481a1058e55f1ac936489cad3ddb', "aria-controls": this.controls, "aria-selected": toAriaBoolean(this.selected), id: id, role: "tab", tabIndex: this.selected && !this.disabled ? 0 : -1 }, h(InteractiveContainer, { key: 'dede575160963d2463e50f6e8baab92319acda9f', disabled: this.disabled }, h("div", { key: '384fab5a193878dcf8509718b94ceaace0c3e370', class: {
                container: true,
                [CSS.iconPresent]: !!this.iconStart || !!this.iconEnd,
                [`scale-${this.scale}`]: true,
            }, hidden: closed, ref: (el) => this.resizeObserver?.observe(el) }, h("div", { key: '9663b1a3178d18c6a9049241189bfd5db9c20eee', class: { [CSS.content]: true, [CSS.contentHasText]: this.hasText } }, this.iconStart ? iconStartEl : null, h("slot", { key: '34f878add4124ea2f10bb9153ef15bafe602071d' }), this.iconEnd ? iconEndEl : null), this.renderCloseButton()))));
    }
    renderCloseButton() {
