...
import { k as focusElementInGroup } from './dom-acbb9e0d.js';
...
const TableRow = class {
    ...
    render() {
        return (h(Host, { key: '1d51f5351ce604d34d7b5a8c6ff241d1f1bb7121' }, h(InteractiveContainer, { key: '67d835df1a6a91ebddd1742f76bdf45407bce5e5', disabled: this.disabled }, h("tr", { key: '008cd752567987e27df6468f21e4baf71ddca901', "aria-disabled": this.disabled, "aria-rowindex": this.positionAll + 1, "aria-selected": this.selected, class: { [CSS.lastVisibleRow]: this.lastVisibleRow }, onKeyDown: this.keyDownHandler, ref: (el) => (this.tableRowEl = el) }, this.numbered && this.renderNumberedCell(), this.selectionMode !== "none" && this.renderSelectableCell(), h("slot", { key: '0f79c326202a63c358ecf4e6231b96123c2bedb2', onSlotchange: this.updateCells, ref: (el) => (this.tableRowSlotEl = el) })))));
    }
