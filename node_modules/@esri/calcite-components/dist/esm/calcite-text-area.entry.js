 ...
 * v2.9.0
 */
import { r as registerInstance, c as createEvent, h, f as forceUpdate, H as Host, g as getElement } from './index-2fab6cb8.js';
import { c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './form-1928b513.js';
import { c as connectLabel, d as disconnectLabel, g as getLabelText } from './label-e5374a88.js';
import { t as toAriaBoolean, b as slotChangeHasAssignedElement } from './dom-acbb9e0d.js';
...
import { b as componentLoaded, s as setUpLoadableComponent, a as setComponentLoaded, c as componentFocusable } from './loadable-d9ec45c6.js';
...
const TextArea = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'd457e39960155acef2958e6ed809b1a3ac334028' }, h(InteractiveContainer, { key: 'a3bfe30414830e1a793ab7e8231a126e6963906f', disabled: this.disabled }, h("textarea", { key: 'a1b350f2b9006bd6e05549edda0de0a1d259863e', "aria-describedby": this.guid, "aria-invalid": toAriaBoolean(this.isCharacterLimitExceeded()), "aria-label": getLabelText(this), autofocus: this.el.autofocus, class: {
                [CSS.readOnly]: this.readOnly,
                [CSS.textAreaInvalid]: this.isCharacterLimitExceeded(),
                [CSS.footerSlotted]: this.endSlotHasElements && this.startSlotHasElements,
                [CSS.blockSizeFull]: !hasFooter,
                [CSS.borderColor]: !hasFooter,
            }, cols: this.columns, disabled: this.disabled, name: this.name, onChange: this.handleChange, onInput: this.handleInput, placeholder: this.placeholder, readOnly: this.readOnly, ref: this.setTextAreaEl, required: this.required, rows: this.rows, value: this.value, wrap: this.wrap }), h("span", { key: '03b147914ccd080d34c1a5c61cba86219257c64d', class: { [CSS.content]: true } }, h("slot", { key: '691895ff47da98f0c79a51f109f8c7c2eb0bd7c6', onSlotchange: this.contentSlotChangeHandler })), h("footer", { key: '36c6ec87e6dc84b65969ccc455fb0ab6afa109a2', class: {
                [CSS.footer]: true,
                [CSS.readOnly]: this.readOnly,
                [CSS.hide]: !hasFooter,
            }, ref: (el) => (this.footerEl = el) }, h("div", { key: 'd69b3f29142173f0748ea307509f402edb15670a', class: {
                [CSS.container]: true,
                [CSS.footerEndSlotOnly]: !this.startSlotHasElements && this.endSlotHasElements,
            } }, h("slot", { key: '7d65f2ba112d3257e732ed0be90f9d89f3df582f', name: SLOTS.footerStart, onSlotchange: (event) => (this.startSlotHasElements = slotChangeHasAssignedElement(event)) }), h("slot", { key: 'e1a972b08955ef23e97550a1749ffcd5c5e4935b', name: SLOTS.footerEnd, onSlotchange: (event) => (this.endSlotHasElements = slotChangeHasAssignedElement(event)) })), this.renderCharacterLimit()), h(HiddenFormInputSlot, { key: '485490a69c92cb3def5e92c8b77c27d1c1981dd8', component: this }), this.isCharacterLimitExceeded() && (h("span", { key: '472b365d87b5b0c62c7eaafa9cb9a61c19541d98', "aria-hidden": true, "aria-live": "polite", class: CSS.assistiveText, id: this.guid }, this.replacePlaceHoldersInMessages())), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
