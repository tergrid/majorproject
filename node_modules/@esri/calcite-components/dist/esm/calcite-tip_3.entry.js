...
import { e as getSlotted, g as getElementDir, t as toAriaBoolean } from './dom-acbb9e0d.js';
...
const Tip = class {
    ...
    render() {
        return (h(Fragment, { key: 'e73ae078f92bf5f548ff2e0a8240c3eb213f58c7' }, h("article", { key: '221db7a5ed670198df1ed809942d609a452149a4', class: CSS$1.container }, this.renderHeader(), this.renderContent()), this.renderDismissButton()));
    }
...
const TipGroup = class {
    ...
    render() {
        return h("slot", { key: '284f8e5e3890d264b7131cfcb1ceb7f64f17705c' });
    }
};
