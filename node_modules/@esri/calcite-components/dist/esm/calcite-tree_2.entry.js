...
import { d as focusElement, B as nodeListToArray, e as getSlotted, b as slotChangeHasAssignedElement, g as getElementDir, t as toAriaBoolean, C as filterDirectChildren } from './dom-acbb9e0d.js';
...
const TreeItem = class {
    ...
    render() {
        ...
        const iconStartEl = (h("calcite-icon", { key: 'a249973d78e8cd1ca94be60f5804510e3831a7e4', class: CSS.iconStart, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: getIconScale(this.scale) }));
        return (h(Host, { key: 'd82060e37f784052bd7297d9570ff57ba8125b15', "aria-expanded": this.hasChildren ? toAriaBoolean(isExpanded) : undefined, "aria-hidden": toAriaBoolean(hidden), "aria-selected": this.selected ? "true" : showCheckmark ? "false" : undefined, "calcite-hydrated-hidden": hidden, role: "treeitem", tabIndex: this.disabled ? -1 : 0 }, h(InteractiveContainer, { key: '14ad3db5c910c777b57a1d7e1860cf1942dc857e', disabled: this.disabled }, h("div", { key: '9742f14f4612edddac8d105df8d96894de46d323', class: { [CSS.itemExpanded]: isExpanded } }, h("div", { key: '1efc895929d8f385234a45bcb48db534f12beebe', class: CSS.nodeAndActionsContainer }, h("div", { key: '1315de460da680a17788222b7d5f0dae1c3bf576', class: {
                [CSS.nodeContainer]: true,
                [CSS_UTILITY.rtl]: rtl,
            }, "data-selection-mode": this.selectionMode, ref: (el) => (this.defaultSlotWrapper = el) }, chevron, itemIndicator, this.iconStart ? iconStartEl : null, checkbox ? checkbox : defaultSlotNode), h("div", { key: '4d59f6ee7de6381f65f45fea330e3857dbbea22d', class: CSS.actionsEnd, hidden: !hasEndActions, ref: (el) => (this.actionSlotWrapper = el) }, slotNode)), h("div", { key: 'a56e40d6d33f7011053e838b25fa7763d3121242', class: {
                [CSS.childrenContainer]: true,
                [CSS_UTILITY.rtl]: rtl,
            }, "data-test-id": "calcite-tree-children", onClick: this.childrenClickHandler, role: this.hasChildren ? "group" : undefined }, h("slot", { key: '2ecb28c15aef9d55eb6783f472db09a2c97573ba', name: SLOTS.children }))))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
