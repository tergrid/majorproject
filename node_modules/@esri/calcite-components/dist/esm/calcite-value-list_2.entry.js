...
import { g as getItemIndex, m as mutationObserverCallback, d as deselectRemovedItems, a as deselectSiblingItems, s as selectSiblings, h as handleFilter, b as handleFilterEvent, c as getItemData, k as keyDownHandler, e as moveItemIndex, i as initialize, f as initializeObserver, j as handleInitialFilter, l as cleanUpObserver, n as calciteListFocusOutHandler, r as removeItem, o as calciteListItemChangeHandler, p as calciteInternalListItemValueChangeHandler, q as setUpItems, t as setFocus, L as List, I as ICON_TYPES$1, C as CSS$1, S as SLOTS$1 } from './resources-f845cc77.js';
import { d as dragActive, a as disconnectSortableComponent, c as connectSortableComponent } from './sortableComponent-0ad7009a.js';
import { d as focusElement, e as getSlotted } from './dom-acbb9e0d.js';
...
const ValueList = class {
    ...
    render() {
        return (h(List, { key: '2ea5ebbc75e1535376ac43da1fded54ca476978d', onBlur: this.handleBlur, onFocusin: this.handleFocusIn, onKeyDown: this.keyDownHandler, props: this }));
    }
